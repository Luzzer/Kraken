# UAGENT — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/uagent-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/uagent-logo-text.svg" alt="UAGENT" width="500">
    </picture>
</p>

<p align="center">
  <a href="https://github.com/uagent/uagent/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/uagent/uagent/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/uagent/uagent/releases"><img src="https://img.shields.io/github/v/release/uagent/uagent?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**UAGENT** is a _personal AI assistant_ you run on your own devices.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/uagent/uagent/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers/models are supported, for the best experience and lower prompt-injection risk use the strongest latest-generation model available to you. See [Onboarding](https://docs.uagent.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.uagent.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.uagent.ai/concepts/model-failover)
...
Fresh-clone acceptance bar: [Windows fresh clone checklist](docs/install/windows-fresh-clone.md)

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.16+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.uagent.ai/start/getting-started)

```bash
uagent onboard --install-daemon

uagent gateway --port 18789 --verbose

# Send a message
uagent message send --to +1234567890 --message "Hello from UAGENT"
...
uagent agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.uagent.ai/install/updating) (and run `uagent doctor`).
...
Switch channels (git + npm): `uagent update --channel stable|beta|dev`.
Details: [Development channels](https://docs.uagent.ai/install/development-channels).
...
pnpm uagent onboard --install-daemon

# Dev loop (auto-reload on source/config changes)
pnpm gateway:watch
```

Note: `pnpm uagent ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `uagent` binary.

## Security defaults (DM access)

UAGENT connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.uagent.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `uagent pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `uagent doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.uagent.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.uagent.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.uagent.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.uagent.ai/nodes/voicewake) + [Talk Mode](https://docs.uagent.ai/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.uagent.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.uagent.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.uagent.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.uagent.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.uagent.ai/nodes).
- **[Onboarding](https://docs.uagent.ai/start/wizard) + [skills](https://docs.uagent.ai/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=uagent/uagent&type=date&legend=top-left)](https://www.star-history.com/#uagent/uagent&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.uagent.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.uagent.ai/web), and [Canvas host](https://docs.uagent.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.uagent.ai/tools/agent-send): gateway, agent, send, [onboarding](https://docs.uagent.ai/start/wizard), and [doctor](https://docs.uagent.ai/gateway/doctor).
- [Pi agent runtime](https://docs.uagent.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.uagent.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.uagent.ai/channels/groups).
- [Media pipeline](https://docs.uagent.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.uagent.ai/nodes/audio).

### Channels

- [Channels](https://docs.uagent.ai/channels): [WhatsApp](https://docs.uagent.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.uagent.ai/channels/telegram) (grammY), [Slack](https://docs.uagent.ai/channels/slack) (Bolt), [Discord](https://docs.uagent.ai/channels/discord) (discord.js), [Google Chat](https://docs.uagent.ai/channels/googlechat) (Chat API), [Signal](https://docs.uagent.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.uagent.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.uagent.ai/channels/imessage) (legacy imsg), [IRC](https://docs.uagent.ai/channels/irc), [Microsoft Teams](https://docs.uagent.ai/channels/msteams), [Matrix](https://docs.uagent.ai/channels/matrix), [Feishu](https://docs.uagent.ai/channels/feishu), [LINE](https://docs.uagent.ai/channels/line), [Mattermost](https://docs.uagent.ai/channels/mattermost), [Nextcloud Talk](https://docs.uagent.ai/channels/nextcloud-talk), [Nostr](https://docs.uagent.ai/channels/nostr), [Synology Chat](https://docs.uagent.ai/channels/synology-chat), [Tlon](https://docs.uagent.ai/channels/tlon), [Twitch](https://docs.uagent.ai/channels/twitch), [Zalo](https://docs.uagent.ai/channels/zalo), [Zalo Personal](https://docs.uagent.ai/channels/zalouser), WeChat (`@tencent-weixin/uagent-weixin`), [WebChat](https://docs.uagent.ai/web/webchat).
- [Group routing](https://docs.uagent.ai/channels/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.uagent.ai/channels).

### Apps + nodes

- [macOS app](https://docs.uagent.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.uagent.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.uagent.ai/nodes/talk) overlay, [WebChat](https://docs.uagent.ai/web/webchat), debug tools, [remote gateway](https://docs.uagent.ai/gateway/remote) control.
- [iOS node](https://docs.uagent.ai/platforms/ios): [Canvas](https://docs.uagent.ai/platforms/mac/canvas), [Voice Wake](https://docs.uagent.ai/nodes/voicewake), [Talk Mode](https://docs.uagent.ai/nodes/talk), camera, screen recording, Bonjour + device pairing.
- [Android node](https://docs.uagent.ai/platforms/android): Connect tab (setup code/manual), chat sessions, voice tab, [Canvas](https://docs.uagent.ai/platforms/mac/canvas), camera/screen recording, and Android device commands (notifications/location/SMS/photos/contacts/calendar/motion/app update).
- [macOS node mode](https://docs.uagent.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.uagent.ai/tools/browser): dedicated uagent Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.uagent.ai/platforms/mac/canvas): [A2UI](https://docs.uagent.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.uagent.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.uagent.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.uagent.ai/automation/cron-jobs); [webhooks](https://docs.uagent.ai/automation/webhook); [Gmail Pub/Sub](https://docs.uagent.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.uagent.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.uagent.ai/channels/channel-routing), [retry policy](https://docs.uagent.ai/concepts/retry), and [streaming/chunking](https://docs.uagent.ai/concepts/streaming).
- [Presence](https://docs.uagent.ai/concepts/presence), [typing indicators](https://docs.uagent.ai/concepts/typing-indicators), and [usage tracking](https://docs.uagent.ai/concepts/usage-tracking).
- [Models](https://docs.uagent.ai/concepts/models), [model failover](https://docs.uagent.ai/concepts/model-failover), and [session pruning](https://docs.uagent.ai/concepts/session-pruning).
- [Security](https://docs.uagent.ai/gateway/security) and [troubleshooting](https://docs.uagent.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.uagent.ai/web) + [WebChat](https://docs.uagent.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.uagent.ai/gateway/tailscale) or [SSH tunnels](https://docs.uagent.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.uagent.ai/install/nix) for declarative config; [Docker](https://docs.uagent.ai/install/docker)-based installs.
- [Doctor](https://docs.uagent.ai/gateway/doctor) migrations, [logging](https://docs.uagent.ai/logging).
...
- **[Gateway WebSocket network](https://docs.uagent.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.uagent.ai/gateway)).
- **[Tailscale exposure](https://docs.uagent.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.uagent.ai/gateway/remote)).
- **[Browser control](https://docs.uagent.ai/tools/browser)** — uagent‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.uagent.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.uagent.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.uagent.ai/nodes/voicewake) + [Talk Mode](https://docs.uagent.ai/nodes/talk)** — wake words on macOS/iOS plus continuous voice on Android.
- **[Nodes](https://docs.uagent.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

UAGENT can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (UAGENT enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.uagent.ai/gateway/tailscale) · [Web surfaces](https://docs.uagent.ai/web)
...
Details: [Remote access](https://docs.uagent.ai/gateway/remote) · [Nodes](https://docs.uagent.ai/nodes) · [Security](https://docs.uagent.ai/gateway/security)
...
Details: [Nodes](https://docs.uagent.ai/nodes) · [macOS app](https://docs.uagent.ai/platforms/macos) · [Gateway protocol](https://docs.uagent.ai/concepts/architecture)
...
Details: [Session tools](https://docs.uagent.ai/concepts/session-tool)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.uagent.ai/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `uagent nodes …`.

Runbook: [iOS connect](https://docs.uagent.ai/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`uagent devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.uagent.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.uagent/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.uagent/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.uagent/uagent.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.uagent.ai/gateway/configuration)
...
Details: [Security guide](https://docs.uagent.ai/gateway/security) · [Docker + sandboxing](https://docs.uagent.ai/install/docker) · [Sandbox config](https://docs.uagent.ai/gateway/configuration)

### [WhatsApp](https://docs.uagent.ai/channels/whatsapp)

- Link the device: `pnpm uagent channels login` (stores creds in `~/.uagent/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.uagent.ai/channels/telegram)
...
### [Slack](https://docs.uagent.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.uagent.ai/channels/discord)
...
### [Signal](https://docs.uagent.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.uagent.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.uagent.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.uagent.ai/channels/msteams)
...
- Official Tencent plugin via [`@tencent-weixin/uagent-weixin`](https://www.npmjs.com/package/@tencent-weixin/uagent-weixin) (iLink Bot API). Private chats only; v2.x requires UAGENT `>=2026.3.22`.
- Install: `uagent plugins install "@tencent-weixin/uagent-weixin"`, then `uagent channels login --channel uagent-weixin` to scan the QR code.
- Requires the WeChat ClawBot plugin (WeChat > Me > Settings > Plugins); gradual rollout by Tencent.

### [WebChat](https://docs.uagent.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.uagent.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.uagent.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.uagent.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.uagent.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.uagent.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.uagent.ai/gateway/remote)
- [Follow UAGENT Onboard for a guided setup.](https://docs.uagent.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.uagent.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.uagent.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.uagent.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.uagent.ai/platforms/windows), [Linux](https://docs.uagent.ai/platforms/linux), [macOS](https://docs.uagent.ai/platforms/macos), [iOS](https://docs.uagent.ai/platforms/ios), [Android](https://docs.uagent.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.uagent.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.uagent.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.uagent.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.uagent.ai/gateway/bonjour)
- [Gateway pairing](https://docs.uagent.ai/gateway/pairing)
- [Remote gateway README](https://docs.uagent.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.uagent.ai/web/control-ui)
- [Dashboard](https://docs.uagent.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.uagent.ai/gateway/health)
- [Gateway lock](https://docs.uagent.ai/gateway/gateway-lock)
- [Background process](https://docs.uagent.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.uagent.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.uagent.ai/logging)

## Deep dives

- [Agent loop](https://docs.uagent.ai/concepts/agent-loop)
- [Presence](https://docs.uagent.ai/concepts/presence)
- [TypeBox schemas](https://docs.uagent.ai/concepts/typebox)
- [RPC adapters](https://docs.uagent.ai/reference/rpc)
- [Queue](https://docs.uagent.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.uagent.ai/tools/skills-config)
- [Default AGENTS](https://docs.uagent.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.uagent.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.uagent.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.uagent.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.uagent.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.uagent.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.uagent.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.uagent.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.uagent.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.uagent.ai/platforms/mac/voicewake)
- [iOS node](https://docs.uagent.ai/platforms/ios)
- [Android node](https://docs.uagent.ai/platforms/android)
- [Windows (WSL2)](https://docs.uagent.ai/platforms/windows)
- [Linux app](https://docs.uagent.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.uagent.ai/gmail-pubsub](https://docs.uagent.ai/automation/gmail-pubsub)

## Molty

UAGENT was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [uagent.ai](https://uagent.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@uagent](https://x.com/uagent)
...
<p align="left">
  ...
  <a href="https://github.com/mattqdev"><img src="https://avatars.githubusercontent.com/u/115874885?v=4&s=48" width="48" height="48" alt="MattQ" title="MattQ"/></a> <a href="https://github.com/Milofax"><img src="https://avatars.githubusercontent.com/u/2537423?v=4&s=48" width="48" height="48" alt="Milofax" title="Milofax"/></a> <a href="https://github.com/stevebot-alive"><img src="https://avatars.githubusercontent.com/u/261149299?v=4&s=48" width="48" height="48" alt="Steve (UAGENT)" title="Steve (UAGENT)"/></a> <a href="https://github.com/ZetiMente"><img src="https://avatars.githubusercontent.com/u/76985631?v=4&s=48" width="48" height="48" alt="Matthew" title="Matthew"/></a> <a href="https://github.com/Cassius0924"><img src="https://avatars.githubusercontent.com/u/62874592?v=4&s=48" width="48" height="48" alt="Cassius0924" title="Cassius0924"/></a> <a href="https://github.com/0xbrak"><img src="https://avatars.githubusercontent.com/u/181251288?v=4&s=48" width="48" height="48" alt="0xbrak" title="0xbrak"/></a> <a href="https://github.com/8BlT"><img src="https://avatars.githubusercontent.com/u/162764392?v=4&s=48" width="48" height="48" alt="8BlT" title="8BlT"/></a> <a href="https://github.com/Abdul535"><img src="https://avatars.githubusercontent.com/u/54276938?v=4&s=48" width="48" height="48" alt="Abdul535" title="Abdul535"/></a> <a href="https://github.com/abhaymundhara"><img src="https://avatars.githubusercontent.com/u/62872231?v=4&s=48" width="48" height="48" alt="abhaymundhara" title="abhaymundhara"/></a> <a href="https://github.com/aduk059"><img src="https://avatars.githubusercontent.com/u/257603478?v=4&s=48" width="48" height="48" alt="aduk059" title="aduk059"/></a>
