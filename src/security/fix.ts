...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof UAGENTConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: UAGENTConfig; env: NodeJS.ProcessEnv }): {
  cfg: UAGENTConfig;
  changes: string[];
} {
