...
let originalUAGENTTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalUAGENTTestConsole = process.env.UAGENT_TEST_CONSOLE;
  process.env.UAGENT_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalUAGENTTestConsole === undefined) {
    delete process.env.UAGENT_TEST_CONSOLE;
  } else {
    process.env.UAGENT_TEST_CONSOLE = originalUAGENTTestConsole;
  }
