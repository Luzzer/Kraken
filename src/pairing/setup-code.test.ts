...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("UAGENT_GATEWAY_TOKEN", "");
    vi.stubEnv("UAGENT_GATEWAY_PASSWORD", "");
    vi.stubEnv("UAGENT_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses UAGENT_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          UAGENT_GATEWAY_TOKEN: "new-token",
        },
