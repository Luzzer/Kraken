...
describe("npm registry spec validation", () => {
  it.each([
    "@uagent/voice-call",
    "@uagent/voice-call@1.2.3",
    "@uagent/voice-call@1.2.3-beta.4",
    "@uagent/voice-call@latest",
    "@uagent/voice-call@beta",
  ])("accepts %s", (spec) => {
  ...
  it.each([
    ...
    {
      spec: "git+ssh://github.com/uagent/uagent",
      expected: "URLs are not allowed",
    },
    {
...
describe("npm registry spec parsing helpers", () => {
  it.each([
    ...
    {
      spec: "@uagent/voice-call@1.2.3-beta.1",
      expected: {
        name: "@uagent/voice-call",
        raw: "@uagent/voice-call@1.2.3-beta.1",
  ...
  it.each([
    {
      spec: "@uagent/voice-call",
      resolvedVersion: "1.2.3-beta.1",
      expected: `Use "@uagent/voice-call@beta"`,
    },
    {
      spec: "@uagent/voice-call@beta",
      resolvedVersion: "1.2.3-rc.1",
