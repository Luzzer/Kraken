...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): UAGENTConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): UAGENTConfig {
  return {
