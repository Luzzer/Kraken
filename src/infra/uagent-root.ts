...
import { openClawRootFs, openClawRootFsSync } from "./uagent-root.fs.runtime.js";

const CORE_PACKAGE_NAMES = new Set(["uagent"]);
...
export async function resolveUAGENTPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveUAGENTPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
