  ...
  return withEnvAsync(
    {
      ...
      UAGENT_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when UAGENT_VERSION is not set", async () => {
  ...
  it("prefers UAGENT_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over UAGENT_SERVICE_VERSION when UAGENT_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        UAGENT_VERSION: " ",
        UAGENT_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when UAGENT_VERSION and UAGENT_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        UAGENT_VERSION: " ",
        UAGENT_SERVICE_VERSION: "\t",
