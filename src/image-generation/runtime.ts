...
function buildNoImageGenerationModelConfiguredMessage(cfg: UAGENTConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: UAGENTConfig }) {
