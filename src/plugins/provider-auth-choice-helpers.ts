...
export function applyProviderAuthConfigPatch(cfg: UAGENTConfig, patch: unknown): UAGENTConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: patchModels as NonNullable<
          NonNullable<UAGENTConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  };
...
export function applyDefaultModel(cfg: UAGENTConfig, model: string): UAGENTConfig {
