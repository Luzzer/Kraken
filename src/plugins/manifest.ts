...
export const PLUGIN_MANIFEST_FILENAME = "uagent.plugin.json";
...
// package.json "uagent" metadata (used for setup/catalog)
...
export type UAGENTPackageStartup = {
  /**
...
export type UAGENTPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: UAGENTPackageStartup;
};
...
): UAGENTPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
