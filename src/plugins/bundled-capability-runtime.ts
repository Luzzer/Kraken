...
function applyVitestCapabilityAliasOverrides(params: {
  ...
  const {
    ["uagent/plugin-sdk"]: _ignoredLegacyRootAlias,
    ["@uagent/plugin-sdk"]: _ignoredScopedRootAlias,
    ...scopedAliasMap
  } = params.aliasMap;
  return {
    ...scopedAliasMap,
...
function resolvePluginModuleExport(moduleExport: unknown): {
  ...
  if (resolved && typeof resolved === "object") {
    const definition = resolved as UAGENTPluginDefinition;
    return {
      definition,
