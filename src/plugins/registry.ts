...
import type {
  ...
  UAGENTPluginApi,
  UAGENTPluginChannelRegistration,
  UAGENTPluginCliCommandDescriptor,
  UAGENTPluginCliRegistrar,
  UAGENTPluginCommandDefinition,
  PluginConversationBindingResolvedEvent,
  UAGENTPluginHttpRouteAuth,
  UAGENTPluginHttpRouteMatch,
  UAGENTPluginHttpRouteHandler,
  UAGENTPluginHttpRouteParams,
  UAGENTPluginHookOptions,
  UAGENTPluginNodeHostCommand,
  UAGENTPluginReloadRegistration,
  UAGENTPluginSecurityAuditCollector,
  MediaUnderstandingProviderPlugin,
  ProviderPlugin,
  RealtimeVoiceProviderPlugin,
  UAGENTPluginService,
  UAGENTPluginToolContext,
  UAGENTPluginToolFactory,
  PluginConfigUiHint,
  PluginDiagnostic,
  PluginBundleFormat,
  PluginFormat,
...
export type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: UAGENTPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
  rootDir?: string;
...
export type PluginCliRegistration = {
  pluginId: string;
  pluginName?: string;
  register: UAGENTPluginCliRegistrar;
  commands: string[];
...
export type PluginReloadRegistration = {
  pluginId: string;
  pluginName?: string;
  registration: UAGENTPluginReloadRegistration;
  source: string;
  rootDir?: string;
};
...
export type PluginNodeHostCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: UAGENTPluginNodeHostCommand;
  source: string;
  rootDir?: string;
};
...
export type PluginSecurityAuditCollectorRegistration = {
  pluginId: string;
  pluginName?: string;
  collector: UAGENTPluginSecurityAuditCollector;
  source: string;
  rootDir?: string;
};
...
export type PluginCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: UAGENTPluginCommandDefinition;
  source: string;
  rootDir?: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: UAGENTPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: UAGENTPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: UAGENTPluginHookOptions | undefined,
    config: UAGENTPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: UAGENTPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: UAGENTPluginChannelRegistration | ChannelPlugin,
    mode: PluginRegistrationMode = "full",
  ) => {
    const normalized =
      typeof (registration as UAGENTPluginChannelRegistration).plugin === "object"
        ? (registration as UAGENTPluginChannelRegistration)
  ...
  const registerCli = (
    ...
    opts?: { commands?: string[]; descriptors?: UAGENTPluginCliCommandDescriptor[] },
  ) => {
  ...
  const registerReload = (record: PluginRecord, registration: UAGENTPluginReloadRegistration) => {
    const normalize = (values?: string[]) =>
      (values ?? []).map((value) => value.trim()).filter(Boolean);
    const normalized: UAGENTPluginReloadRegistration = {
  ...
  const registerNodeHostCommand = (
    record: PluginRecord,
    nodeCommand: UAGENTPluginNodeHostCommand,
  ) => {
  ...
  const registerService = (record: PluginRecord, service: UAGENTPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: UAGENTPluginCommandDefinition) => {
