...
describe("plugin loader CLI metadata", () => {
  ...
  register(api) {
    ...
    const registry = await loadUAGENTPluginCliRegistry({
      env: { ...process.env, UAGENT_STATE_DIR: stateDir },
      logger: {
        info: () => {},
  ...
  it("uses the real channel entry in cli-metadata mode for CLI metadata capture", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@uagent/cli-metadata-channel",
          uagent: { extensions: ["./index.cjs"], setupEntry: "./setup-entry.cjs" },
        },
        null,
        2,
      ),
    ...
    fs.writeFileSync(
      ...
      `const { defineChannelPluginEntry } = require("uagent/plugin-sdk/core");
...
module.exports = {
  ...
  it("skips bundled channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    process.env.UAGENT_BUNDLED_PLUGINS_DIR = bundledRoot;

    fs.writeFileSync(
      path.join(pluginDir, "package.json"),
      JSON.stringify(
        {
          name: "@uagent/bundled-skip-channel",
          uagent: { extensions: ["./index.cjs"] },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("prefers bundled channel cli-metadata entries over full channel entries", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@uagent/bundled-cli-channel",
          uagent: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("skips bundled non-channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@uagent/bundled-skip-provider",
          uagent: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during full plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@uagent/full-cli-metadata-channel",
          uagent: { extensions: ["./index.cjs"] },
        },
        null,
        2,
