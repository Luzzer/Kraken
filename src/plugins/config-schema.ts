...
import type { PluginConfigUiHint, UAGENTPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: UAGENTPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): UAGENTPluginConfigSchema {
  return {
