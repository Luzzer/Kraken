...
export function applyProviderDefaultModel(cfg: UAGENTConfig, modelRef: string): UAGENTConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: UAGENTConfig; modelId: string; modelRef: string; profileId: string } {
