...
export function applyGoogleGeminiModelDefault(cfg: UAGENTConfig): {
  next: UAGENTConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: UAGENTConfig): UAGENTConfig {
...
export function applyOpenAIConfig(cfg: UAGENTConfig): UAGENTConfig {
...
export function applyOpencodeGoModelDefault(cfg: UAGENTConfig): {
  next: UAGENTConfig;
  changed: boolean;
} {
