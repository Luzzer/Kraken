...
import type { UAGENTPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = UAGENTPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("uagent.pluginCommandsState");
