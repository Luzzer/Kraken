...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile("imessage", "runtime-api.ts")]: [
    'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin, type UAGENTConfig } from "uagent/plugin-sdk/core";',
    ...
    'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "uagent/plugin-sdk/status-helpers";',
    'export { formatTrimmedAllowFromEntries } from "uagent/plugin-sdk/channel-config-helpers";',
    ...
    'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiUAGENTConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
  ],
  [bundledPluginFile("googlechat", "runtime-api.ts")]: [
    'export { DEFAULT_ACCOUNT_ID } from "uagent/plugin-sdk/account-id";',
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "uagent/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema } from "uagent/plugin-sdk/channel-config-primitives";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "uagent/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "uagent/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "uagent/plugin-sdk/channel-lifecycle";',
    ...
    'export { evaluateGroupRouteAccessForPolicy, resolveDmGroupAccessWithLists, resolveSenderScopedGroupPolicy } from "uagent/plugin-sdk/channel-policy";',
    'export { PAIRING_APPROVED_MESSAGE } from "uagent/plugin-sdk/channel-status";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, isDangerousNameMatchingEnabled, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "uagent/plugin-sdk/config-runtime";',
    ...
    'export { GoogleChatConfigSchema, type GoogleChatAccountConfig, type GoogleChatConfig } from "uagent/plugin-sdk/googlechat-runtime-shared";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "uagent/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "uagent/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile("matrix", "runtime-api.ts")]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "uagent/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, UAGENTConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "uagent/plugin-sdk/matrix-runtime-shared";',
    'export { formatZonedTimestamp } from "uagent/plugin-sdk/matrix-runtime-shared";',
  ...
  [bundledPluginFile("nextcloud-talk", "runtime-api.ts")]: [
    'export * from "uagent/plugin-sdk/nextcloud-talk";',
  ...
  [bundledPluginFile("telegram", "runtime-api.ts")]: [
    ...
    'export type { UAGENTPluginService, UAGENTPluginServiceContext, PluginLogger } from "uagent/plugin-sdk/core";',
    'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "uagent/plugin-sdk/acp-runtime";',
    'export { AcpRuntimeError } from "uagent/plugin-sdk/acp-runtime";',
    'export { clearAccountEntryFields, emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "uagent/plugin-sdk/core";',
    ...
    'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "uagent/plugin-sdk/channel-status";',
    'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "uagent/plugin-sdk/channel-actions";',
    ...
    'export type { UAGENTConfig } from "uagent/plugin-sdk/config-runtime";',
    'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeUAGENTConfig["channels"]>["telegram"] >;',
