...
import type {
  ...
  UAGENTPluginApi as CoreUAGENTPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "uagent/plugin-sdk/core";
import * as providerEntrySdk from "uagent/plugin-sdk/provider-entry";
...
import type {
  ...
  UAGENTPluginApi as SharedUAGENTPluginApi,
...
import type { UAGENTPluginApi } from "../types.js";
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps the deprecated channel-runtime shim unused in repo imports", () => {
    const matches = findRepoFilesContaining({
      ...
      pattern: /uagent\/plugin-sdk\/channel-runtime/u,
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreUAGENTPluginApi>().toMatchTypeOf<UAGENTPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreUAGENTPluginApi>().toMatchTypeOf<SharedUAGENTPluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("uagent/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("uagent/plugin-sdk/channel-actions"),
      importResolvedPluginSdkSubpath("uagent/plugin-sdk/global-singleton"),
      importResolvedPluginSdkSubpath("uagent/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("uagent/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("uagent/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("uagent/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("uagent/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`uagent/plugin-sdk/${id}`),
      ),
    ]);
