 ...
 *
 * @see https://github.com/uagent/uagent/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an UAGENTConfig.
 */
export function timestampOptsFromConfig(cfg: UAGENTConfig): TimestampInjectionOptions {
  return {
