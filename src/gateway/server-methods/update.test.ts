...
vi.mock("../../infra/uagent-root.js", async () => {
  const actual = await vi.importActual<typeof import("../../infra/uagent-root.js")>(
    "../../infra/uagent-root.js",
  );
  return {
    ...actual,
    resolveUAGENTPackageRoot: async () => "/tmp/uagent",
  };
});
