...
describe("gateway auth", () => {
  ...
  it("resolves token/password from UAGENT gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          UAGENT_GATEWAY_TOKEN: "env-token",
          UAGENT_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides UAGENT_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        UAGENT_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
