...
export function hasAmbiguousGatewayAuthModeConfig(cfg: UAGENTConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: UAGENTConfig): void {
