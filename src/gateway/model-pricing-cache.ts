...
export function collectConfiguredModelPricingRefs(config: UAGENTConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: UAGENTConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
