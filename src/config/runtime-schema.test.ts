...
import type { ConfigFileSnapshot, UAGENTConfig } from "./types.js";

const mockLoadConfig = vi.hoisted(() => vi.fn<() => UAGENTConfig>());
...
function makeSnapshot(params: { valid: boolean; config?: UAGENTConfig }): ConfigFileSnapshot {
  return {
