...
export type UAGENTConfig = {
  meta?: {
    /** Last UAGENT version that wrote this config. */
  ...
  ui?: {
    /** Accent color for UAGENT UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
type BrandedConfigState<TState extends string> = UAGENTConfig & {
