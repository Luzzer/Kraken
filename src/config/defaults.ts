...
export function applyMessageDefaults(cfg: UAGENTConfig): UAGENTConfig {
...
export function applyTalkConfigNormalization(config: UAGENTConfig): UAGENTConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: UAGENTConfig): UAGENTConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: UAGENTConfig): UAGENTConfig {
...
export function applyLoggingDefaults(cfg: UAGENTConfig): UAGENTConfig {
...
export function applyContextPruningDefaults(cfg: UAGENTConfig): UAGENTConfig {
  return (
...
export function applyCompactionDefaults(cfg: UAGENTConfig): UAGENTConfig {
