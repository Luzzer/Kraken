...
function resolveWatchPaths(workspaceDir: string, config?: UAGENTConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: UAGENTConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: UAGENTConfig }) {
