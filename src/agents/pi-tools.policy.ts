...
export function resolveSubagentToolPolicy(cfg?: UAGENTConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: UAGENTConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: UAGENTConfig["tools"];
