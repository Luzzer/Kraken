...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.uagent/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "uagent doctor" and "uagent approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
