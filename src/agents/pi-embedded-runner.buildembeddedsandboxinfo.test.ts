...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/uagent-sandbox",
    agentWorkspaceDir: "/tmp/uagent-workspace",
    workspaceAccess: "none",
    runtimeId: "uagent-sbx-test",
    runtimeLabel: "uagent-sbx-test",
    containerName: "uagent-sbx-test",
    ...
    browser: {
      ...
      containerName: "uagent-sbx-browser-test",
    },
