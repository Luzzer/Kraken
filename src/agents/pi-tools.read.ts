...
function resolveAdaptiveReadMaxBytes(options?: UAGENTReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createUAGENTReadTool(base, {
...
export function createUAGENTReadTool(
  base: AnyAgentTool,
  options?: UAGENTReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
