...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<UAGENTConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<UAGENTConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: UAGENTConfig): WebSearchConfig {
