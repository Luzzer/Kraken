...
const SIMPLE_TRANSPORT_API_ALIAS: Record<string, Api> = {
  "openai-responses": "uagent-openai-responses-transport",
  "openai-codex-responses": "uagent-openai-responses-transport",
  "openai-completions": "uagent-openai-completions-transport",
  "azure-openai-responses": "uagent-azure-openai-responses-transport",
  "anthropic-messages": "uagent-anthropic-messages-transport",
  "google-generative-ai": "uagent-google-generative-ai-transport",
};
