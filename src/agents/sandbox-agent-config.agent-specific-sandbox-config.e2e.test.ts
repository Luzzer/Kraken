...
async function resolveContext(config: UAGENTConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): UAGENTConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
