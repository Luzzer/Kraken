...
const CLEANUP_STATE_KEY = Symbol.for("uagent.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("uagent.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("uagent.sessionWriteLockWatchdogState");
