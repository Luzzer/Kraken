...
export const DEFAULT_SANDBOX_IMAGE = "uagent-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "uagent-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "uagent-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "uagent-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "uagent-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "uagent-sandbox-browser";
