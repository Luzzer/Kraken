...
export function isCliProvider(provider: string, cfg?: UAGENTConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: UAGENTConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: UAGENTConfig }): ModelCatalogEntry[] {
