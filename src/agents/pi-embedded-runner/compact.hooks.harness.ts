...
export const createUAGENTCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createUAGENTCodingToolsMock.mockReset();
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureUAGENTModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveUAGENTDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createUAGENTCodingTools: createUAGENTCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveUAGENTAgentDir: vi.fn(() => "/tmp"),
  }));
