export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_UAGENT_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_UAGENT_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[UAGENT_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[UAGENT_INTERNAL_CONTEXT_END]]";
