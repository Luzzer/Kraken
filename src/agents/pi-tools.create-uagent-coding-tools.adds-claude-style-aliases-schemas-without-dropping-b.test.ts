...
const defaultTools = createUAGENTCodingTools({ senderIsOwner: true });

describe("createUAGENTCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const disabledOpenAiTools = createUAGENTCodingTools({
    ...
    const anthropicTools = createUAGENTCodingTools({
      config: disabledConfig,
    ...
    const allowModelsConfig: UAGENTConfig = {
      tools: {
        exec: {
    ...
    const allowed = createUAGENTCodingTools({
    ...
    const denied = createUAGENTCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
    ...
    const oauthTools = createUAGENTCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
