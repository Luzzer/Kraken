...
import { resolveUAGENTPluginToolInputs } from "./uagent-tools.plugin-context.js";
...
type UAGENTToolsDeps = {
  callGateway: typeof callGateway;
  config?: UAGENTConfig;
};

const defaultUAGENTToolsDeps: UAGENTToolsDeps = {
  callGateway,
};

let openClawToolsDeps: UAGENTToolsDeps = defaultUAGENTToolsDeps;
...
function isExperimentalPlanToolEnabled(config?: UAGENTConfig): boolean {
  return config?.tools?.experimental?.planTool === true;
}

export function createUAGENTTools(
  options?: {
...
export const __testing = {
  setDepsForTest(overrides?: Partial<UAGENTToolsDeps>) {
    openClawToolsDeps = overrides
      ? {
          ...defaultUAGENTToolsDeps,
          ...overrides,
        }
      : defaultUAGENTToolsDeps;
  },
