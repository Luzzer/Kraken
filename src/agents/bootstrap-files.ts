...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "uagent:bootstrap-context:full";

export function resolveContextInjectionMode(config?: UAGENTConfig): AgentContextInjection {
