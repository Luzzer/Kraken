...
import type { UAGENTPluginApi } from "../plugins/types.js";
...
export type { UAGENTPluginToolContext, UAGENTPluginToolFactory } from "../plugins/types.js";
export type {
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: UAGENTPluginApi) => void;
  registerFull?: (api: UAGENTPluginApi) => void;
};
...
type DefinedChannelPluginEntry<TPlugin> = {
  ...
  register: (api: UAGENTPluginApi) => void;
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: UAGENTConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
