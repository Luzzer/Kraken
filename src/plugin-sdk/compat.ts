...
const shouldWarnCompatImport =
  ...
  process.env.UAGENT_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "uagent/plugin-sdk/compat is deprecated for new plugins. Migrate to focused uagent/plugin-sdk/<subpath> imports. See https://docs.uagent.ai/plugins/sdk-migration",
    {
      code: "UAGENT_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.uagent.ai/plugins/sdk-migration",
    },
  );
}
