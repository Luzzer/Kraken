...
export type { UAGENTConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: UAGENTConfig, ...args: TArgs) => UAGENTConfig;
  applyConfig: (cfg: UAGENTConfig, ...args: TArgs) => UAGENTConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: UAGENTConfig, preset: TParams) => UAGENTConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: UAGENTConfig): {
  next: UAGENTConfig;
  changed: boolean;
} {
