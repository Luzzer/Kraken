...
export const A2UI_PATH = "/__uagent__/a2ui";

export const CANVAS_HOST_PATH = "/__uagent__/canvas";

export const CANVAS_WS_PATH = "/__uagent__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.uagentCanvasA2UIAction.postMessage(...)
  // - Android: window.uagentCanvasA2UIAction.postMessage(...)
  const handlerNames = ["uagentCanvasA2UIAction"];
  ...
  globalThis.UAGENT = globalThis.UAGENT ?? {};
  globalThis.UAGENT.postMessage = postToNode;
  globalThis.UAGENT.sendUserAction = sendUserAction;
  globalThis.uagentPostMessage = postToNode;
  globalThis.uagentSendUserAction = sendUserAction;
