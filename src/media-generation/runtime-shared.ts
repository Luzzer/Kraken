...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: UAGENTConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: UAGENTConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: UAGENTConfig;
  agentDir?: string;
  listProviders: (cfg?: UAGENTConfig) => CapabilityProviderCandidate[];
}): string[] {
