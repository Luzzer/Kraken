...
function resolveRealtimeVoiceProviderEntries(cfg?: UAGENTConfig): RealtimeVoiceProviderPlugin[] {
...
export function listRealtimeVoiceProviders(cfg?: UAGENTConfig): RealtimeVoiceProviderPlugin[] {
