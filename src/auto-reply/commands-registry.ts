...
export function isCommandEnabled(cfg: UAGENTConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: UAGENTConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: UAGENTConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: UAGENTConfig) {
