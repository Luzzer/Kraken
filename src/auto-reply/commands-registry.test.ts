...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@uagent", { botUsername: "uagent" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@uagent args", {
        botUsername: "uagent",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "uagent" })).toBe(
      "/help@otherbot",
    );
  });
