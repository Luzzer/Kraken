...
function createDiscordParams(commandBody: string, cfg: UAGENTConfig = baseCfg) {
...
function createThreadParams(commandBody: string, cfg: UAGENTConfig = baseCfg) {
...
async function runDiscordAcpCommand(commandBody: string, cfg: UAGENTConfig = baseCfg) {
  return handleAcpCommand(createDiscordParams(commandBody, cfg), true);
}

async function runThreadAcpCommand(commandBody: string, cfg: UAGENTConfig = baseCfg) {
  return handleAcpCommand(createThreadParams(commandBody, cfg), true);
}

async function runTelegramAcpCommand(commandBody: string, cfg: UAGENTConfig = baseCfg) {
...
async function runTelegramDmAcpCommand(commandBody: string, cfg: UAGENTConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runSlackDmAcpCommand(commandBody: string, cfg: UAGENTConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
function createMatrixThreadParams(commandBody: string, cfg: UAGENTConfig = baseCfg) {
...
async function runMatrixAcpCommand(commandBody: string, cfg: UAGENTConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runMatrixThreadAcpCommand(commandBody: string, cfg: UAGENTConfig = baseCfg) {
  return handleAcpCommand(createMatrixThreadParams(commandBody, cfg), true);
}

async function runFeishuDmAcpCommand(commandBody: string, cfg: UAGENTConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runLineDmAcpCommand(commandBody: string, cfg: UAGENTConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runBlueBubblesDmAcpCommand(commandBody: string, cfg: UAGENTConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runIMessageDmAcpCommand(commandBody: string, cfg: UAGENTConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
  ...
  it("sanitizes leaked task and runtime details in ACP status output", async () => {
    ...
    hoisted.readAcpSessionEntryMock.mockReturnValue({
      ...
      acp: {
        ...
        lastError: [
          "UAGENT runtime context (internal):",
    ...
    expect(result?.reply?.text).not.toContain("UAGENT runtime context (internal):");
