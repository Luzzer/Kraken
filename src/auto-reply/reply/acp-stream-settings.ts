...
function resolveAcpStreamCoalesceIdleMs(cfg: UAGENTConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: UAGENTConfig): number {
...
export function resolveAcpProjectionSettings(cfg: UAGENTConfig): AcpProjectionSettings {
