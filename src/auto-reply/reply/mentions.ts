...
function resolveMentionPatterns(cfg: UAGENTConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: UAGENTConfig | undefined, agentId?: string): RegExp[] {
