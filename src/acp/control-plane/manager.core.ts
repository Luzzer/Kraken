...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: UAGENTConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: UAGENTConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: UAGENTConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: UAGENTConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: UAGENTConfig }): Promise<void> {
