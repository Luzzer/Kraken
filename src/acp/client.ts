...
export async function createAcpClient(opts: AcpClientOptions = {}): Promise<AcpClientHandle> {
  ...
  const defaultServerCommand = entryPath ? process.execPath : "uagent";
  ...
  await client.initialize({
    ...
    clientInfo: { name: "uagent-acp-client", version: "1.0.0" },
  });
