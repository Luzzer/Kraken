...
export function isAcpEnabledByPolicy(cfg: UAGENTConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: UAGENTConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: UAGENTConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: UAGENTConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: UAGENTConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: UAGENTConfig, agentId: string): boolean {
