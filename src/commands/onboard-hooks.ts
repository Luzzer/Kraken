...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.uagent.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("uagent hooks list")}`,
      `  ${formatCliCommand("uagent hooks enable <name>")}`,
      `  ${formatCliCommand("uagent hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
