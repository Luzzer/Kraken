...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://uagent.local")).toBe("https://uagent.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://uagent.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: uagent security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://uagent.local" },
      ...
      { Item: "Security", Value: "Run: uagent security audit --deep" },
