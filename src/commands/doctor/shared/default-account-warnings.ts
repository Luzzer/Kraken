...
export function collectMissingDefaultAccountBindingWarnings(cfg: UAGENTConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: UAGENTConfig): string[] {
  const warnings: string[] = [];
