...
export function scanLegacyToolsBySenderKeys(cfg: UAGENTConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: UAGENTConfig): {
  config: UAGENTConfig;
  changes: string[];
} {
