...
function collectExecSafeBinScopes(cfg: UAGENTConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: UAGENTConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: UAGENTConfig): {
  config: UAGENTConfig;
  changes: string[];
  warnings: string[];
} {
