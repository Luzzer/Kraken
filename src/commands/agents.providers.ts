...
function resolveDefaultAccountId(cfg: UAGENTConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: UAGENTConfig): boolean {
...
export function summarizeBindings(cfg: UAGENTConfig, bindings: AgentBinding[]): string[] {
