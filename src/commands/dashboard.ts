...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set UAGENT_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `uagent dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control UAGENT.");
  } else if (hint) {
    runtime.log(hint);
  }
}
