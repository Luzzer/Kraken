...
function noteFlowRecoveryHints() {
  ...
  note(
    [
      ...
      `Inspect: ${formatCliCommand("uagent tasks flow show <flow-id>")}`,
      `Cancel: ${formatCliCommand("uagent tasks flow cancel <flow-id>")}`,
    ]
...
export function noteWorkspaceStatus(cfg: UAGENTConfig) {
