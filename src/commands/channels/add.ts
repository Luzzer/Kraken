...
import { replaceConfigFile, type UAGENTConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: UAGENTConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as UAGENTConfig;
  ...
  // May trigger loadUAGENTPlugins on cache miss (disk scan + jiti import)
