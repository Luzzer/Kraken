...
function buildNoVideoGenerationModelConfiguredMessage(cfg: UAGENTConfig): string {
...
export function listRuntimeVideoGenerationProviders(params?: { config?: UAGENTConfig }) {
