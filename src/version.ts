...
declare const __UAGENT_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "uagent";
...
function resolveVersionFromRuntimeSources(params: {
  ...
  const preferredCandidates =
    params.preference === "env-first"
      ? [params.env["UAGENT_VERSION"], params.runtimeVersion]
      : [params.runtimeVersion, params.env["UAGENT_VERSION"]];
  return (
    firstNonEmpty(
      ...preferredCandidates,
      params.env["UAGENT_SERVICE_VERSION"],
...
// Single source of truth for the current UAGENT version.
// - Embedded/bundled builds: injected define or env var.
// - Dev/npm builds: package.json.
export const VERSION = resolveBinaryVersion({
  moduleUrl: import.meta.url,
  injectedVersion: typeof __UAGENT_VERSION__ === "string" ? __UAGENT_VERSION__ : undefined,
  bundledVersion: process.env.UAGENT_BUNDLED_VERSION,
});
