import type { UAGENTConfig, HookConfig } from "../config/config.js";
...
const HOOK_SOURCE_POLICIES: Record<HookSource, HookSourcePolicy> = {
  "uagent-bundled": {
    ...
    canOverride: ["uagent-bundled"],
    canBeOverriddenBy: ["uagent-managed", "uagent-plugin"],
  },
  "uagent-plugin": {
    precedence: 20,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["uagent-bundled", "uagent-plugin"],
    canBeOverriddenBy: ["uagent-managed"],
  },
  "uagent-managed": {
    precedence: 30,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["uagent-bundled", "uagent-managed", "uagent-plugin"],
    canBeOverriddenBy: ["uagent-managed"],
  },
  "uagent-workspace": {
    precedence: 40,
    ...
    canOverride: ["uagent-workspace"],
    canBeOverriddenBy: ["uagent-workspace"],
  },
};
...
export function resolveHookEnableState(params: {
  ...
  if (entry.hook.source === "uagent-plugin") {
    return { enabled: true };
  }
