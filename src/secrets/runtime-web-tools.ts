...
type FetchConfig = NonNullable<UAGENTConfig["tools"]>["web"] extends infer Web
...
function hasPluginWebToolConfig(config: UAGENTConfig): boolean {
...
function hasCustomWebSearchPluginRisk(config: UAGENTConfig): boolean {
