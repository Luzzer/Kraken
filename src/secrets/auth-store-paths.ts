...
export function listAuthProfileStorePaths(config: UAGENTConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: UAGENTConfig, stateDir: string): string[] {
