...
function resolveResolutionLimits(config: UAGENTConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: UAGENTConfig): SecretProviderConfig {
