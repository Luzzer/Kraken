...
import type { UAGENTPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, UAGENTPackageManifest>>;

const ENV_CATALOG_PATHS = ["UAGENT_PLUGIN_CATALOG_PATHS", "UAGENT_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<UAGENTPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
