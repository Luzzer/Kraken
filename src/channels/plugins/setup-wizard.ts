...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: UAGENTConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: UAGENTConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: UAGENTConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: UAGENTConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: UAGENTConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: UAGENTConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: UAGENTConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: UAGENTConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: UAGENTConfig) => UAGENTConfig;
