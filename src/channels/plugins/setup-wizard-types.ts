...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: UAGENTConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
...
export type ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: UAGENTConfig, accountId?: string) => DmPolicy;
  setPolicy: (cfg: UAGENTConfig, policy: DmPolicy, accountId?: string) => UAGENTConfig;
