...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: UAGENTConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: UAGENTConfig }>(
  collector: WarningCollector<{ cfg: UAGENTConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: UAGENTConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: UAGENTConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: UAGENTConfig },
>(
  projectCfg: (cfg: UAGENTConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: UAGENTConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: UAGENTConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: UAGENTConfig },
>(params: {
  providerConfigPresent: (cfg: UAGENTConfig) => boolean;
