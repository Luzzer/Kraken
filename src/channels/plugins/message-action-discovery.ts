...
export function listChannelMessageActions(cfg: UAGENTConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: UAGENTConfig): ChannelMessageCapability[] {
