...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: UAGENTConfig): string | undefined {
  ...
  function listAccountIds(cfg: UAGENTConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: UAGENTConfig): string {
