...
export type ChannelConfigAdapter<ResolvedAccount> = {
  listAccountIds: (cfg: UAGENTConfig) => string[];
  resolveAccount: (cfg: UAGENTConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: UAGENTConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: UAGENTConfig) => string;
  setAccountEnabled?: (params: {
    cfg: UAGENTConfig;
    accountId: string;
    enabled: boolean;
  }) => UAGENTConfig;
  deleteAccount?: (params: { cfg: UAGENTConfig; accountId: string }) => UAGENTConfig;
  isEnabled?: BivariantCallback<(account: ResolvedAccount, cfg: UAGENTConfig) => boolean>;
  disabledReason?: BivariantCallback<(account: ResolvedAccount, cfg: UAGENTConfig) => string>;
  isConfigured?: BivariantCallback<
    (account: ResolvedAccount, cfg: UAGENTConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: BivariantCallback<(account: ResolvedAccount, cfg: UAGENTConfig) => string>;
  describeAccount?: BivariantCallback<
    (account: ResolvedAccount, cfg: UAGENTConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: UAGENTConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: UAGENTConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: BivariantCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: UAGENTConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.uagent.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: UAGENTConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: UAGENTConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: UAGENTConfig;
    nextCfg: UAGENTConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: UAGENTConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: UAGENTConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: UAGENTConfig; accountId?: string | null }) =>
    | {
