    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["uagent channels list", "List configured channels and auth profiles."],
          ["uagent channels status --probe", "Run channel status checks and probes."],
          [
            "uagent channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["uagent channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.uagent.ai/cli/channels",
        )}\n`,
    );
