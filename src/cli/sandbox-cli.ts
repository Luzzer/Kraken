...
const SANDBOX_EXAMPLES = {
  main: [
    ["uagent sandbox list", "List all sandbox containers."],
    ["uagent sandbox list --browser", "List only browser containers."],
    ["uagent sandbox recreate --all", "Recreate all containers."],
    ["uagent sandbox recreate --session main", "Recreate a specific session."],
    ["uagent sandbox recreate --agent mybot", "Recreate agent containers."],
    ["uagent sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["uagent sandbox list", "List all sandbox containers."],
    ["uagent sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["uagent sandbox recreate --all", "Recreate all containers."],
    ["uagent sandbox recreate --session main", "Recreate a specific session."],
    ["uagent sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["uagent sandbox recreate --browser --all", "Recreate only browser containers."],
    ["uagent sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["uagent sandbox explain", "Show effective sandbox config."],
    ["uagent sandbox explain --session agent:main:main", "Explain a specific session."],
    ["uagent sandbox explain --agent work", "Explain an agent sandbox."],
    ["uagent sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.uagent.ai/cli/sandbox")}\n`,
    )
    .action(() => {
