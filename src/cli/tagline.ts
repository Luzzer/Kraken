const DEFAULT_TAGLINE = "All your chats, one UAGENT.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—the assistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just got an upgrade—type something and let the assistant handle the busywork.",
  ...
  "Automation with intent: minimal fuss, maximal throughput.",
  ...
  "Let's ship something useful, stable, and mildly responsible.",
  "I'll smooth out your workflow until the rough edges stop mattering.",
  "Shell yeah—I'm here to cut the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The assistant in your contacts you actually want to hear from.",
  ...
  "Built for humans who want less busywork and more signal.",
  ...
  "Half butler, half debugger, fully operational.",
  ...
  "You had me at 'uagent gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.UAGENT_TAGLINE_INDEX;
