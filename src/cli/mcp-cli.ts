...
import { serveUAGENTChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage UAGENT MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose UAGENT channels over MCP stdio")
