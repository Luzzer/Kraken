...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: UAGENTConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: UAGENTConfig, mode: ChannelAuthMode): string {
