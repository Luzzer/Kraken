    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["uagent directory self --channel slack", "Show the connected account identity."],
          [
            'uagent directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["uagent directory groups list --channel discord", "List available groups/channels."],
          [
            "uagent directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.uagent.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
