      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["uagent gateway run", "Run the gateway in the foreground."],
            ["uagent gateway status", "Show service status and probe reachability."],
            ["uagent gateway discover", "Find local and wide-area gateway beacons."],
            ["uagent gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.uagent.ai/cli/gateway")}\n`,
      ),
  );
