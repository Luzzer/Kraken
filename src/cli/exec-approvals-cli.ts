...
import { readBestEffortConfig, type UAGENTConfig } from "../config/config.js";
import {
...
export function registerExecApprovalsCli(program: Command) {
  ...
  const approvals = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/approvals", "docs.uagent.ai/cli/approvals")}\n`,
    );
