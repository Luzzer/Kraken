...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.UAGENT_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.UAGENT_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.UAGENT_SERVICE_MARKER = originalServiceMarker;
    }
  });
  ...
  it("disables detached mode in service-managed runtime", async () => {
    process.env.UAGENT_SERVICE_MARKER = "uagent";
