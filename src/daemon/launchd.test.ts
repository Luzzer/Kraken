...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.uagent.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", UAGENT_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.uagent.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when UAGENT_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.uagent.gateway.plist",
    },
    {
      name: "uses profile-specific label when UAGENT_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", UAGENT_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.uagent.jbphoenix.plist",
    },
    {
      name: "prefers UAGENT_LAUNCHD_LABEL over UAGENT_PROFILE",
      env: {
        HOME: "/Users/test",
        UAGENT_PROFILE: "jbphoenix",
        UAGENT_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from UAGENT_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        UAGENT_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty UAGENT_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        UAGENT_PROFILE: "myprofile",
        UAGENT_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.uagent.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
