...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("uagent.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("uagent.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: UAGENTConfig): Promise<ContextEngine> {
