/**
 * Standalone MCP server that exposes UAGENT plugin-registered tools
...
function resolveTools(config: UAGENTConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  const server = new Server(
    { name: "uagent-plugin-tools", version: VERSION },
    { capabilities: { tools: {} } },
  );
