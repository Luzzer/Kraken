...
export function listBindings(cfg: UAGENTConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: UAGENTConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: UAGENTConfig) {
