---
summary: "Use SOUL.md to give your UAGENT agent an actual voice instead of generic assistant sludge"
read_when:
...
UAGENT injects it on normal sessions, so it has real weight. If your agent
...
For UAGENT, `SOUL.md` is that layer.
...
Path fixed for UAGENT workspaces: use `SOUL.md`, not `http://SOUL.md`.
