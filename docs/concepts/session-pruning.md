...
UAGENT also runs a separate idempotent cleanup for older legacy sessions that
...
UAGENT auto-enables pruning for Anthropic profiles:
...
If you set explicit values, UAGENT does not override them.
