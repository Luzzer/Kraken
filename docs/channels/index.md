---
summary: "Messaging platforms UAGENT can connect to"
read_when:
  - You want to choose a chat channel for UAGENT
...
UAGENT can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- [WeChat](https://www.npmjs.com/package/@tencent-weixin/uagent-weixin) — Tencent iLink Bot plugin via QR login; private chats only.
...
- Channels can run simultaneously; configure multiple and UAGENT will route per chat.
