---
summary: "UAGENT tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools UAGENT provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    UAGENT), others are **external** (published on npm by the community).
...
These tools ship with UAGENT and are available without installing any plugins:
...
| `group:uagent`   | All built-in UAGENT tools (excludes plugin tools)                                                       |
