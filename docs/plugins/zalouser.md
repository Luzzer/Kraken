...
read_when:
  - You want Zalo Personal (unofficial) support in UAGENT
...
Zalo Personal support for UAGENT via a plugin, using native `zca-js` to automate a normal Zalo user account.
