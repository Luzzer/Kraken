...
summary: "Testing utilities and patterns for UAGENT plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for UAGENT
plugins.
...
**Import:** `uagent/plugin-sdk/testing`
...
} from "uagent/plugin-sdk/testing";
```
...
import { installCommonResolveTargetErrorCases } from "uagent/plugin-sdk/testing";
...
import type { PluginRuntime } from "uagent/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `uagent/plugin-sdk` root barrel is rejected
...
UAGENT uses Vitest with V8 coverage thresholds. For plugin tests:
