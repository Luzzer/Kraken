...
UAGENT treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.uagent/settings/voicewake.json`

Shape:

```json
{ "triggers": ["uagent", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
