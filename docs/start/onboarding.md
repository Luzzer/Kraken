---
summary: "First-run setup flow for UAGENT (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give UAGENT">
...
<Step title="CLI">
  ...
  The app can install the global `uagent` CLI via npm, pnpm, or bun.
