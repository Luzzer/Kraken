---
summary: "Overview of UAGENT onboarding options and flows"
read_when:
...
UAGENT has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `uagent onboard`                     | Launch the app            |
...
CLI command docs: [`uagent onboard`](/cli/onboard)

## macOS app onboarding

Open the UAGENT app. The first-run wizard walks you through the same steps
