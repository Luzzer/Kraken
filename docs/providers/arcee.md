...
read_when:
  - You want to use Arcee AI with UAGENT
...
uagent onboard --auth-choice arceeai-api-key

# Via OpenRouter
uagent onboard --auth-choice arceeai-openrouter
```
...
UAGENT currently ships this bundled Arcee catalog:
