...
You can point UAGENT at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or UAGENT
...
- [Anthropic provider](/providers/anthropic) - Native UAGENT integration with Claude CLI or API keys
