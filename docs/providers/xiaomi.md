---
summary: "Use Xiaomi MiMo models with UAGENT"
read_when:
  - You want Xiaomi MiMo models in UAGENT
...
Xiaomi MiMo is the API platform for **MiMo** models. UAGENT uses the Xiaomi
...
```bash
uagent onboard --auth-choice xiaomi-api-key
# or non-interactive
uagent onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
