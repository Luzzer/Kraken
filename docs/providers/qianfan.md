---
summary: "Use Qianfan's unified API to access many models in UAGENT"
read_when:
...
3. UAGENT installed on your system
...
4. Copy the API key for use with UAGENT

## CLI setup

```bash
uagent onboard --auth-choice qianfan-api-key
```
...
- [UAGENT Configuration](/gateway/configuration)
