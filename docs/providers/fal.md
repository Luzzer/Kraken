---
title: "fal"
summary: "fal image and video generation setup in UAGENT"
read_when:
  - You want to use fal image generation in UAGENT
...
UAGENT ships a bundled `fal` provider for hosted image and video generation.
...
```bash
uagent onboard --auth-choice fal-api-key
```
