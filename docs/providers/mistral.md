---
summary: "Use Mistral models and Voxtral transcription with UAGENT"
read_when:
  - You want to use Mistral models in UAGENT
...
UAGENT supports Mistral for both text/image model routing (`mistral/...`) and
...
```bash
uagent onboard --auth-choice mistral-api-key
# or non-interactive
uagent onboard --mistral-api-key "$MISTRAL_API_KEY"
```
...
UAGENT currently ships this bundled Mistral catalog:
