---
summary: "Use NVIDIA's OpenAI-compatible API in UAGENT"
read_when:
  - You want to use NVIDIA models in UAGENT
...
uagent onboard --auth-choice skip
uagent models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
