---
summary: "Use Z.AI (GLM models) with UAGENT"
read_when:
  - You want Z.AI / GLM models in UAGENT
...
for authentication. Create your API key in the Z.AI console. UAGENT uses the `zai` provider
with a Z.AI API key.
...
UAGENT currently seeds the bundled `zai` provider with:
