...
- Code: `.agents/skills/uagent-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/uagent-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
