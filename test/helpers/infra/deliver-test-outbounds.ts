...
function resolveSignalMaxBytes(cfg: UAGENTConfig, accountId?: string): number | undefined {
...
function resolveSignalTextChunkLimit(cfg: UAGENTConfig, accountId?: string | null): number {
  const signalCfg = cfg.channels?.signal as
    | {
