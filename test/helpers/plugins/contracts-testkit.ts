...
import type { UAGENTPluginApi } from "../../../src/plugins/types.js";
...
export function createPluginRegistryFixture(config = {} as UAGENTConfig) {
  return {
    config,
...
export function registerVirtualTestPlugin(params: {
  ...
  register(this: void, api: UAGENTPluginApi): void;
}) {
  registerTestPlugin({
