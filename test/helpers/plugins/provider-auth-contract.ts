...
type LoginOpenAICodexOAuth =
  (typeof import("uagent/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("uagent/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("uagent/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("uagent/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("uagent/plugin-sdk/provider-auth-login", async () => {
  const actual = await vi.importActual<typeof import("uagent/plugin-sdk/provider-auth-login")>(
    "uagent/plugin-sdk/provider-auth-login",
  );
  return {
    ...actual,
...
vi.mock("uagent/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("uagent/plugin-sdk/provider-auth")>(
    "uagent/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
