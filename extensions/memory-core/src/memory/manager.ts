...
import { extractKeywords } from "uagent/plugin-sdk/memory-core-host-engine-qmd";
import {
  readMemoryFile,
...
const MEMORY_INDEX_MANAGER_CACHE_KEY = Symbol.for("uagent.memoryIndexManagerCache");
...
export class MemoryIndexManager extends MemoryManagerEmbeddingOps implements MemorySearchManager {
  ...
  protected readonly cfg: UAGENTConfig;
