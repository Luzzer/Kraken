...
import type { checkQmdBinaryAvailability as checkQmdBinaryAvailabilityFn } from "uagent/plugin-sdk/memory-core-host-engine-qmd";
...
vi.mock("uagent/plugin-sdk/memory-core-host-engine-qmd", () => ({
...
function createQmdCfg(agentId: string): UAGENTConfig {
  return {
...
function createBuiltinCfg(agentId: string): UAGENTConfig {
  return {
    agents: {
      defaults: {
