...
import { resolveUserPath } from "uagent/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "uagent/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall UAGENT (this should install node-llama-cpp): npm i -g uagent@latest"
      : null,
