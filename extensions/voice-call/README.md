...
Official Voice Call plugin for **UAGENT**.
...
Docs: `https://docs.uagent.ai/plugins/voice-call`
Plugin system: `https://docs.uagent.ai/plugin`

## Install (local dev)

### Option A: install via UAGENT (recommended)
...
- advanced webhook, streaming, and tunnel notes: `https://docs.uagent.ai/plugins/voice-call`
...
`https://docs.uagent.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.uagent.ai/plugins/voice-call#tts-for-calls`
