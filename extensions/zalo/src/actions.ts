import { jsonResult, readStringParam } from "uagent/plugin-sdk/channel-actions";
import type {
...
import { extractToolSend } from "uagent/plugin-sdk/tool-send";
...
function listEnabledAccounts(cfg: UAGENTConfig, accountId?: string | null) {
  return (
