...
function mergeZaloAccountConfig(cfg: UAGENTConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: UAGENTConfig): ResolvedZaloAccount[] {
