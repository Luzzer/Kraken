/**
 * Twitch channel plugin for UAGENT.
 *
...
} from "uagent/plugin-sdk/channel-pairing";
 ...
 * for UAGENT. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: UAGENTConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: UAGENTConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        defaultAccountId: (cfg: UAGENTConfig): string => resolveDefaultTwitchAccountId(cfg),
        isConfigured: (_account: unknown, cfg: UAGENTConfig): boolean =>
      ...
      resolver: {
        resolveTargets: async ({
          ...
          runtime: import("uagent/plugin-sdk/runtime-env").RuntimeEnv;
