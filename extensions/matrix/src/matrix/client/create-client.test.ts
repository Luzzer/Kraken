...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/uagent-matrix-create-client-test",
    storagePath: "/tmp/uagent-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/uagent-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/uagent-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/uagent-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "uagent-matrix-default-token-hash",
