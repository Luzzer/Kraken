...
import type { ChunkMode } from "uagent/plugin-sdk/reply-runtime";
import { describe, expect, it, vi } from "vitest";
import type { UAGENTConfig, PluginRuntime } from "../../runtime-api.js";
...
describe("deliverMattermostReplyPayload", () => {
  it("passes agent-scoped mediaLocalRoots when sending media paths", async () => {
    ...
    const stateDir = await fs.mkdtemp(path.join(os.tmpdir(), "uagent-mm-state-"));
    ...
    try {
      ...
      const cfg = {} satisfies UAGENTConfig;
