import { createAccountListHelpers } from "uagent/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "uagent/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "uagent/plugin-sdk/account-resolution";
import {
...
export function listMattermostAccountIds(cfg: UAGENTConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: UAGENTConfig): string {
...
export function listEnabledMattermostAccounts(cfg: UAGENTConfig): ResolvedMattermostAccount[] {
