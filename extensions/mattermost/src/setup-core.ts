import type { ChannelSetupAdapter } from "uagent/plugin-sdk/channel-setup";
import { createSetupInputPresenceValidator } from "uagent/plugin-sdk/setup-runtime";
import {
...
export function resolveMattermostAccountWithSecrets(cfg: UAGENTConfig, accountId: string) {
