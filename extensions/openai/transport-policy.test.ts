import type { ProviderRuntimeModel } from "uagent/plugin-sdk/plugin-entry";
  ...
  it("builds native turn state for direct OpenAI routes", () => {
    expect(
      ...
      headers: {
        ...
        "x-uagent-session-id": "session-123",
        "x-uagent-turn-id": "turn-123",
        "x-uagent-turn-attempt": "2",
      },
      metadata: {
        uagent_session_id: "session-123",
        uagent_turn_id: "turn-123",
        uagent_turn_attempt: "2",
        uagent_transport: "websocket",
      },
    });
  });
