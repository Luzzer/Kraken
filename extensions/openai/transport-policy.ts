...
export function resolveOpenAITransportTurnState(
  ...
  return {
    headers: {
      ...sessionHeaders,
      "x-uagent-turn-id": turnId,
      "x-uagent-turn-attempt": attempt,
    },
    metadata: {
      uagent_session_id: sessionHeaders["x-uagent-session-id"] ?? "",
      uagent_turn_id: turnId,
      uagent_turn_attempt: attempt,
      uagent_transport: ctx.transport,
    },
  };
}
