...
function areWhatsAppAgentReactionsEnabled(params: { cfg: UAGENTConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: UAGENTConfig) {
