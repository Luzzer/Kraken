import type { getReplyFromConfig } from "uagent/plugin-sdk/reply-runtime";
import type { MsgContext } from "uagent/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "uagent/plugin-sdk/routing";
import { buildGroupHistoryKey } from "uagent/plugin-sdk/routing";
...
export function createWebOnMessageHandler(params: {
  ...
  replyLogger: ReturnType<(typeof import("uagent/plugin-sdk/runtime-env"))["getChildLogger"]>;
