...
import { resolveOAuthDir } from "uagent/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: UAGENTConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: UAGENTConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: UAGENTConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: UAGENTConfig): ResolvedWhatsAppAccount[] {
