...
import { loadConfig, type UAGENTConfig } from "uagent/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "uagent/plugin-sdk/config-runtime";
import { recordChannelActivity } from "uagent/plugin-sdk/infra-runtime";
import { maxBytesForKind } from "uagent/plugin-sdk/media-runtime";
import { extensionForMime } from "uagent/plugin-sdk/media-runtime";
import { unlinkIfExists } from "uagent/plugin-sdk/media-runtime";
import type { PollInput } from "uagent/plugin-sdk/media-runtime";
import { resolveChunkMode } from "uagent/plugin-sdk/reply-chunking";
import type { RetryConfig } from "uagent/plugin-sdk/retry-runtime";
import { resolvePreferredUAGENTTmpDir } from "uagent/plugin-sdk/temp-path";
import { convertMarkdownTables } from "uagent/plugin-sdk/text-runtime";
import { loadWebMediaRaw } from "uagent/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredUAGENTTmpDir();
