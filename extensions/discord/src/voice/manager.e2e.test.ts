...
vi.mock("uagent/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("uagent/plugin-sdk/routing")>(
...
vi.mock("uagent/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("uagent/plugin-sdk/agent-runtime")>(
