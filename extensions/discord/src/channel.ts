...
} from "uagent/plugin-sdk/allowlist-config-edit";
import { createScopedDmSecurityResolver } from "uagent/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "uagent/plugin-sdk/channel-contract";
import { createChatChannelPlugin } from "uagent/plugin-sdk/channel-core";
import { createPairingPrefixStripper } from "uagent/plugin-sdk/channel-pairing";
import { createOpenProviderConfiguredRouteWarningCollector } from "uagent/plugin-sdk/channel-policy";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "uagent/plugin-sdk/directory-runtime";
import { formatErrorMessage } from "uagent/plugin-sdk/error-runtime";
import { createLazyRuntimeModule } from "uagent/plugin-sdk/lazy-runtime";
import { resolveOutboundSendDep } from "uagent/plugin-sdk/outbound-runtime";
import { sleepWithAbort } from "uagent/plugin-sdk/runtime-env";
import {
  createComputedAccountStatusAdapter,
  createDefaultChannelRuntimeState,
} from "uagent/plugin-sdk/status-helpers";
import { resolveTargetsWithOptionalToken } from "uagent/plugin-sdk/target-resolver-runtime";
import {
...
function resolveDiscordStartupDelayMs(cfg: UAGENTConfig, accountId: string): number {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). UAGENT adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
