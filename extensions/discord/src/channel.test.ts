...
function createCfg(): UAGENTConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: UAGENTConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: UAGENTConfig, accountId = "default") {
