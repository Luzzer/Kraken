...
import { collectProviderDangerousNameMatchingScopes } from "uagent/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: UAGENTConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: UAGENTConfig,
  doctorFixCommand: string,
): { config: UAGENTConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: UAGENTConfig): string[] {
