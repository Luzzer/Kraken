...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<UAGENTConfig["channels"]>["discord"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<UAGENTConfig["channels"]>["discord"]>>,
): UAGENTConfig {
  return {
    channels: {
      discord: {
