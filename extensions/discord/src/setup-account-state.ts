...
import { listCombinedAccountIds } from "uagent/plugin-sdk/account-resolution";
...
export function listDiscordSetupAccountIds(cfg: UAGENTConfig): string[] {
...
export function resolveDefaultDiscordSetupAccountId(cfg: UAGENTConfig): string {
