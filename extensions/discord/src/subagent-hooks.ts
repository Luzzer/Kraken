import type { UAGENTPluginApi } from "uagent/plugin-sdk/core";
...
function resolveThreadBindingFlags(api: UAGENTPluginApi, accountId?: string) {
...
export function registerDiscordSubagentHooks(api: UAGENTPluginApi) {
