...
import { resolveCommandAuthorizedFromAuthorizers } from "uagent/plugin-sdk/command-auth-native";
import type { DiscordAccountConfig, UAGENTConfig } from "uagent/plugin-sdk/config-runtime";
...
import { logError } from "uagent/plugin-sdk/text-runtime";
import {
