...
type LoadedConfig = ReturnType<typeof import("uagent/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("uagent/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("uagent/plugin-sdk/runtime-env").createSubsystemLogger>;
