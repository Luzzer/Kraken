...
import type { SessionBindingRecord } from "uagent/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "uagent/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "uagent/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("uagent/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("uagent/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("uagent/plugin-sdk/config-runtime").UAGENTConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
