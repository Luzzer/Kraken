...
import { AcpRuntimeError } from "uagent/plugin-sdk/acp-runtime";
...
let runtimeEnvModule: typeof import("uagent/plugin-sdk/runtime-env");
...
function createConfigWithDiscordAccount(overrides: Record<string, unknown> = {}): UAGENTConfig {
  return {
    channels: {
      discord: {
        accounts: {
...
describe("monitorDiscordProvider", () => {
  ...
  beforeAll(async () => {
    vi.doMock("uagent/plugin-sdk/plugin-runtime", async () => {
    ...
    runtimeEnvModule = await import("uagent/plugin-sdk/runtime-env");
