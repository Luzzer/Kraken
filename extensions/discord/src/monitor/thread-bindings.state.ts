...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "uagent/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("uagent.discordThreadBindingsState");
