...
import * as commandRegistryModule from "uagent/plugin-sdk/command-auth";
import type { ChatCommandDefinition, CommandArgsParsing } from "uagent/plugin-sdk/command-auth";
import type { ModelsProviderData } from "uagent/plugin-sdk/command-auth";
import type { UAGENTConfig } from "uagent/plugin-sdk/config-runtime";
import * as dispatcherModule from "uagent/plugin-sdk/reply-dispatch-runtime";
import * as globalsModule from "uagent/plugin-sdk/runtime-env";
import * as commandTextModule from "uagent/plugin-sdk/text-runtime";
