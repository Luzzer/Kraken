...
import type { DiscordAccountConfig } from "uagent/plugin-sdk/config-runtime";
import * as pluginCommandsModule from "uagent/plugin-sdk/plugin-runtime";
...
function createCommand(cfg: UAGENTConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: UAGENTConfig) => void;
