...
import { buildPluginBindingApprovalCustomId } from "uagent/plugin-sdk/conversation-runtime";
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/uagent-sessions-test.json");
