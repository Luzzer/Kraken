...
import type { NativeCommandSpec } from "uagent/plugin-sdk/command-auth";
import type { UAGENTConfig } from "uagent/plugin-sdk/config-runtime";
import { clearPluginCommands, registerPluginCommand } from "uagent/plugin-sdk/plugin-runtime";
...
vi.mock("uagent/plugin-sdk/plugin-runtime", async () => {
  const actual = await vi.importActual<typeof import("uagent/plugin-sdk/plugin-runtime")>(
    "uagent/plugin-sdk/plugin-runtime",
  );
  return {
    ...actual,
...
vi.mock("uagent/plugin-sdk/reply-runtime", async () => {
  const actual = await vi.importActual<typeof import("uagent/plugin-sdk/reply-runtime")>(
...
function createConfig(): UAGENTConfig {
  return {
    channels: {
      discord: {
...
async function createNativeCommand(cfg: UAGENTConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: UAGENTConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
async function createStatusCommand(cfg: UAGENTConfig) {
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("uagent/plugin-sdk/plugin-runtime")
    >("uagent/plugin-sdk/plugin-runtime");
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("uagent/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("uagent/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("uagent/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
    );
