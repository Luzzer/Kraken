...
import type { UAGENTConfig, loadConfig } from "uagent/plugin-sdk/config-runtime";
import { buildPairingReply } from "uagent/plugin-sdk/conversation-runtime";
...
} from "uagent/plugin-sdk/native-command-registry";
import * as pluginRuntime from "uagent/plugin-sdk/plugin-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "uagent/plugin-sdk/reply-chunking";
import {
...
import { createSubsystemLogger, logVerbose } from "uagent/plugin-sdk/runtime-env";
...
type DiscordConfig = NonNullable<UAGENTConfig["channels"]>["discord"];
