...
vi.mock("uagent/plugin-sdk/retry-runtime", async () => {
  const actual = await vi.importActual<typeof import("uagent/plugin-sdk/retry-runtime")>(
    "uagent/plugin-sdk/retry-runtime",
  );
  return {
    ...actual,
