...
import { resolveHumanDelayConfig } from "uagent/plugin-sdk/agent-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "uagent/plugin-sdk/channel-inbound";
import { isDangerousNameMatchingEnabled } from "uagent/plugin-sdk/dangerous-name-runtime";
import { resolveMarkdownTableMode } from "uagent/plugin-sdk/markdown-table-runtime";
import { getAgentScopedMediaLocalRoots } from "uagent/plugin-sdk/media-runtime";
import { createNonExitingRuntime, logVerbose } from "uagent/plugin-sdk/runtime-env";
import { resolveOpenProviderRuntimeGroupPolicy } from "uagent/plugin-sdk/runtime-group-policy";
import { logDebug, logError } from "uagent/plugin-sdk/text-runtime";
...
let replyRuntimePromise: Promise<typeof import("uagent/plugin-sdk/reply-runtime")> | undefined;
let replyPipelineRuntimePromise:
  | Promise<typeof import("uagent/plugin-sdk/channel-reply-pipeline")>
  | undefined;
...
async function _loadReplyRuntime() {
  replyRuntimePromise ??= import("uagent/plugin-sdk/reply-runtime");
  return await replyRuntimePromise;
}
async function loadReplyPipelineRuntime() {
  replyPipelineRuntimePromise ??= import("uagent/plugin-sdk/channel-reply-pipeline");
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__uagent_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__uagent_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__uagent_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__uagent_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__uagent_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__uagent_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "UAGENT form";
  customId = "__uagent_discord_component_modal_wildcard__";
  components = [];
