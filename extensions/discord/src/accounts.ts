...
import { normalizeAccountId } from "uagent/plugin-sdk/account-id";
import { resolveAccountEntry } from "uagent/plugin-sdk/routing";
import type { DiscordAccountConfig, DiscordActionConfig, UAGENTConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: UAGENTConfig): ResolvedDiscordAccount[] {
