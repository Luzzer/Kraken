...
export function resolveTavilySearchConfig(cfg?: UAGENTConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: UAGENTConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: UAGENTConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
