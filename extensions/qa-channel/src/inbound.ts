...
import { dispatchInboundReplyWithBase } from "uagent/plugin-sdk/inbound-reply-dispatch";
...
export async function handleQaInbound(params: {
  ...
  const route = runtime.channel.routing.resolveAgentRoute({
    cfg: params.config as UAGENTConfig,
  ...
  const body = runtime.channel.reply.formatAgentEnvelope({
    ...
    previousTimestamp,
    envelope: runtime.channel.reply.resolveEnvelopeFormatOptions(params.config as UAGENTConfig),
    body: inbound.text,
  });
