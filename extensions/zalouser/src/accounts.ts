...
function mergeZalouserAccountConfig(cfg: UAGENTConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: UAGENTConfig; accountId?: string | null }) {
