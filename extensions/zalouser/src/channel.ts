...
import { createAccountStatusSink } from "uagent/plugin-sdk/channel-lifecycle";
...
import { buildPassiveProbedChannelStatusSummary } from "uagent/plugin-sdk/extension-shared";
...
function resolveZalouserOutboundChunkMode(cfg: UAGENTConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: UAGENTConfig, accountId?: string) {
