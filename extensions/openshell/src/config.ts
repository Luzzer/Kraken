...
import { buildPluginConfigSchema, type UAGENTPluginConfigSchema } from "uagent/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): UAGENTPluginConfigSchema {
