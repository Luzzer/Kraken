...
import { formatSetExplicitDefaultInstruction } from "uagent/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "uagent/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.UAGENT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: UAGENTConfig): string[] {
...
export function listTelegramAccountIds(cfg: UAGENTConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: UAGENTConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/uagent/uagent/issues/30673
...
export function listEnabledTelegramAccounts(cfg: UAGENTConfig): ResolvedTelegramAccount[] {
