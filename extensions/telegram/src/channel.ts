import { DEFAULT_ACCOUNT_ID } from "uagent/plugin-sdk/account-id";
import {
  buildDmGroupAccountAllowlistAdapter,
  createNestedAllowlistOverrideResolver,
} from "uagent/plugin-sdk/allowlist-config-edit";
import type { ChannelMessageActionAdapter } from "uagent/plugin-sdk/channel-contract";
import { clearAccountEntryFields, createChatChannelPlugin } from "uagent/plugin-sdk/channel-core";
import { createPairingPrefixStripper } from "uagent/plugin-sdk/channel-pairing";
import { createAllowlistProviderRouteAllowlistWarningCollector } from "uagent/plugin-sdk/channel-policy";
import { attachChannelToResult } from "uagent/plugin-sdk/channel-send-result";
import {
...
import { createChannelDirectoryAdapter } from "uagent/plugin-sdk/directory-runtime";
import { formatErrorMessage } from "uagent/plugin-sdk/error-runtime";
import {
  resolveOutboundSendDep,
  type OutboundSendDeps,
} from "uagent/plugin-sdk/outbound-runtime";
import { chunkMarkdownText } from "uagent/plugin-sdk/reply-runtime";
import {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as UAGENTConfig;
