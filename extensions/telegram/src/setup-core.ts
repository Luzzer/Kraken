...
import type { ChannelSetupAdapter } from "uagent/plugin-sdk/setup-runtime";
import {
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://uagent.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("uagent logs --follow")}\` (safest)`,
