...
import { safeEqualSecret } from "uagent/plugin-sdk/browser-security-runtime";
import type { UAGENTConfig } from "uagent/plugin-sdk/config-runtime";
import { isDiagnosticsEnabled } from "uagent/plugin-sdk/diagnostic-runtime";
import type { RuntimeEnv } from "uagent/plugin-sdk/runtime-env";
import { defaultRuntime } from "uagent/plugin-sdk/runtime-env";
...
import { readJsonBodyWithLimit } from "uagent/plugin-sdk/webhook-request-guards";
...
function resolveTelegramWebhookClientIp(req: IncomingMessage, config?: UAGENTConfig): string {
