...
function shouldShowTelegramDmAccessWarning(cfg: UAGENTConfig, accountId: string): boolean {
...
function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`uagent config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`uagent config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
