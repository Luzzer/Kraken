...
import { resolveAgentMaxConcurrent } from "uagent/plugin-sdk/config-runtime";
import type { UAGENTConfig } from "uagent/plugin-sdk/config-runtime";
import { loadConfig } from "uagent/plugin-sdk/config-runtime";
import { waitForAbortSignal } from "uagent/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: UAGENTConfig): RunOptions<unknown> {
  return {
    sink: {
