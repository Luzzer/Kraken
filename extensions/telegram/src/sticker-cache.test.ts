...
vi.mock("uagent/plugin-sdk/media-runtime", () => ({
...
const TEST_CACHE_DIR = "/tmp/uagent-test-sticker-cache/telegram";
...
describe("sticker-cache", () => {
  beforeEach(async () => {
    process.env.UAGENT_STATE_DIR = "/tmp/uagent-test-sticker-cache";
    fs.rmSync("/tmp/uagent-test-sticker-cache", { recursive: true, force: true });
