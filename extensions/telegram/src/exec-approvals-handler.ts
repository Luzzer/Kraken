import { buildPluginApprovalPendingReplyPayload } from "uagent/plugin-sdk/approval-reply-runtime";
import type { UAGENTConfig } from "uagent/plugin-sdk/config-runtime";
import {
  createChannelNativeApprovalRuntime,
  resolveExecApprovalRequestAllowedDecisions,
  type ExecApprovalChannelRuntime,
} from "uagent/plugin-sdk/infra-runtime";
import { resolveExecApprovalCommandDisplay } from "uagent/plugin-sdk/infra-runtime";
import {
...
function isHandlerConfigured(params: { cfg: UAGENTConfig; accountId: string }): boolean {
