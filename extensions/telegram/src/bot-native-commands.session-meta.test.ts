...
import type { ResolvedAgentRoute } from "uagent/plugin-sdk/routing";
...
type ResolveConfiguredBindingRouteFn =
  typeof import("uagent/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("uagent/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/uagent-sessions.json");
