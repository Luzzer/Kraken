...
import { isTruthyEnvValue, isWSL2Sync } from "uagent/plugin-sdk/runtime-env";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "UAGENT_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "UAGENT_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "UAGENT_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable UAGENT_TELEGRAM_DNS_RESULT_ORDER
