import { resolveAccountWithDefaultFallback } from "uagent/plugin-sdk/account-core";
import type { UAGENTConfig } from "uagent/plugin-sdk/config-runtime";
import { coerceSecretRef } from "uagent/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "uagent/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "uagent/plugin-sdk/core";
import { resolveDefaultSecretProviderAlias } from "uagent/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "uagent/plugin-sdk/routing";
import {
...
function inspectTokenValue(params: { cfg: UAGENTConfig; value: unknown }): {
  token: string;
