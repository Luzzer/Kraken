...
vi.mock("uagent/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("uagent/plugin-sdk/hook-runtime")>(
    "uagent/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
