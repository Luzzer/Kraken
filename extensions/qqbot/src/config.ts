...
export function listQQBotAccountIds(cfg: UAGENTConfig): string[] {
...
export function resolveDefaultQQBotAccountId(cfg: UAGENTConfig): string {
  const qqbot = cfg.channels?.qqbot as QQBotChannelConfig | undefined;
...
/** Apply account config updates back into the UAGENT config object. */
