...
export const imessageDmPolicy = {
  ...
  resolveConfigKeys: (_cfg: UAGENTConfig, accountId?: string) => {
...
function resolveIMessageCliPath(params: { cfg: UAGENTConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure UAGENT has Full Disk Access to Messages DB.",
...
export const imessageSetupStatusBase = {
  ...
  configuredScore: 1,
  unconfiguredScore: 0,
  resolveConfigured: ({ cfg, accountId }: { cfg: UAGENTConfig; accountId?: string }) =>
