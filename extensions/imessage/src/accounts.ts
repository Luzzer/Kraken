...
function mergeIMessageAccountConfig(cfg: UAGENTConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: UAGENTConfig): ResolvedIMessageAccount[] {
