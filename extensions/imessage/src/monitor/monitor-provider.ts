...
import { createChannelPairingChallengeIssuer } from "uagent/plugin-sdk/channel-pairing";
...
import { readSessionUpdatedAt, resolveStorePath } from "uagent/plugin-sdk/config-runtime";
import {
  readChannelAllowFromStore,
  upsertChannelPairingRequest,
} from "uagent/plugin-sdk/conversation-runtime";
import { recordInboundSession } from "uagent/plugin-sdk/conversation-runtime";
import { normalizeScpRemoteHost } from "uagent/plugin-sdk/host-runtime";
import { waitForTransportReady } from "uagent/plugin-sdk/infra-runtime";
import { isInboundPathAllowed, kindFromMime } from "uagent/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "uagent/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "uagent/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "uagent/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "uagent/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "uagent/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "uagent/plugin-sdk/security-runtime";
import { truncateUtf16Safe } from "uagent/plugin-sdk/text-runtime";
 ...
 *   exec ssh -T uagent@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., uagent@192.168.64.3)
