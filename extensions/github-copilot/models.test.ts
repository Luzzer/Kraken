...
vi.mock("uagent/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("uagent/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/uagent-state",
}));

import type { ProviderResolveDynamicModelContext } from "uagent/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/uagent-state/credentials/github-copilot.token.json";
