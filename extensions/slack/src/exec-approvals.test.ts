...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<UAGENTConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<UAGENTConfig["channels"]>["slack"]>>,
): UAGENTConfig {
  return {
    channels: {
      slack: {
