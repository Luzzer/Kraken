import { formatInboundEnvelope } from "uagent/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "uagent/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("uagent/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
