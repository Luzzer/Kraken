...
import type { SessionScope } from "uagent/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "uagent/plugin-sdk/config-runtime";
import { createDedupeCache } from "uagent/plugin-sdk/core";
import type { HistoryEntry } from "uagent/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("uagent/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
