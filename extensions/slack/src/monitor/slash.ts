...
import { type ChatCommandDefinition, type CommandArgs } from "uagent/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "uagent/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "uagent_cmdarg";
