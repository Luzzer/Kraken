import { collectIssuesForEnabledAccounts } from "uagent/plugin-sdk/status-helpers";
    ...
    collectIssues: ({ account, accountId, issues }) => {
      ...
      if (!configured) {
        issues.push({
          ...
          fix: "Run: uagent channels add bluebubbles --http-url <server-url> --password <password>",
        });
        return;
      }
