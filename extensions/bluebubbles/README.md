...
This package contains the **BlueBubbles external channel plugin** for UAGENT.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `uagent/plugin-sdk` helpers.
