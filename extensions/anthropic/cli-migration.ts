...
type AgentDefaultsModel = NonNullable<NonNullable<UAGENTConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<UAGENTConfig["agents"]>["defaults"]>["models"];
