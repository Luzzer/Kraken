...
>({
  ...
  resolveParams: (_cfg: UAGENTConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: UAGENTConfig): UAGENTConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiResponsesApiConfig(cfg: UAGENTConfig): UAGENTConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: UAGENTConfig): UAGENTConfig {
