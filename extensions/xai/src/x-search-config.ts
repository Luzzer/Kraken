...
export function resolveLegacyXSearchConfig(config?: UAGENTConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: UAGENTConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: UAGENTConfig): JsonRecord | undefined {
