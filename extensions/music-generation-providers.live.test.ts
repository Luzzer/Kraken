...
import { resolveUAGENTAgentDir } from "../src/agents/agent-paths.js";
import { collectProviderApiKeys } from "../src/agents/live-auth-keys.js";
import { isLiveProfileKeyModeEnabled, isLiveTestEnabled } from "../src/agents/live-test-helpers.js";
import { resolveApiKeyForProvider } from "../src/agents/model-auth.js";
import { loadConfig, type UAGENTConfig } from "../src/config/config.js";
...
const providerFilter = parseCsvFilter(process.env.UAGENT_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.UAGENT_LIVE_MUSIC_GENERATION_MODELS);
