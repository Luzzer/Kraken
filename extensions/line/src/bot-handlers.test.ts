...
vi.mock("uagent/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("uagent/plugin-sdk/channel-pairing", () => ({
...
vi.mock("uagent/plugin-sdk/command-auth", () => ({
...
vi.mock("uagent/plugin-sdk/config-runtime", () => ({
...
vi.mock("uagent/plugin-sdk/group-access", () => ({
...
vi.mock("uagent/plugin-sdk/reply-history", () => ({
...
vi.mock("uagent/plugin-sdk/routing", () => ({
