...
import { __testing as sessionBindingTesting } from "uagent/plugin-sdk/conversation-runtime";
...
type AgentBinding = NonNullable<UAGENTConfig["bindings"]>[number];
...
describe("buildLineMessageContext", () => {
  ...
  beforeEach(async () => {
    ...
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "uagent-line-context-"));
