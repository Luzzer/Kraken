import type { ChannelSetupAdapter, UAGENTConfig } from "uagent/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "uagent/plugin-sdk/setup";
...
export function isLineConfigured(cfg: UAGENTConfig, accountId: string): boolean {
