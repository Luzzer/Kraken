...
import { WEBHOOK_IN_FLIGHT_DEFAULTS } from "uagent/plugin-sdk/webhook-request-guards";
...
vi.mock("uagent/plugin-sdk/reply-runtime", () => ({
...
vi.mock("uagent/plugin-sdk/channel-reply-pipeline", () => ({
  createChannelReplyPipeline: vi.fn(() => ({})),
}));

vi.mock("uagent/plugin-sdk/webhook-ingress", () => ({
