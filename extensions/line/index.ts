...
type RegisteredLineCardCommand = Parameters<UAGENTPluginApi["registerCommand"]>[0];

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: UAGENTPluginApi): Promise<RegisteredLineCardCommand> {
