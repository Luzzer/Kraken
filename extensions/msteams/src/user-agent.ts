...
function resolveUAGENTVersion(): string {
  try {
 ...
 * and appends the UAGENT version.
 *
 * Format: "teams.ts[apps]/<sdk-version> UAGENT/<uagent-version>"
 * Example: "teams.ts[apps]/2.0.5 UAGENT/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} UAGENT/${resolveUAGENTVersion()}`;
  return cachedUserAgent;
}
