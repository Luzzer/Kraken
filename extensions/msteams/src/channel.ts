import { describeAccountSnapshot } from "uagent/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "uagent/plugin-sdk/allow-from";
import { createMessageToolCardSchema } from "uagent/plugin-sdk/channel-actions";
import { createTopLevelChannelConfigAdapter } from "uagent/plugin-sdk/channel-config-helpers";
import type {
...
import { createLazyRuntimeNamedExport } from "uagent/plugin-sdk/lazy-runtime";
import { createRuntimeOutboundDelegates } from "uagent/plugin-sdk/outbound-runtime";
import { createComputedAccountStatusAdapter } from "uagent/plugin-sdk/status-helpers";
...
const resolveMSTeamsChannelConfig = (cfg: UAGENTConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: UAGENTConfig }>(
