...
function mergeSignalAccountConfig(cfg: UAGENTConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: UAGENTConfig): ResolvedSignalAccount[] {
