...
import { resolveOutboundAttachmentFromUrl } from "uagent/plugin-sdk/media-runtime";
...
let signalConfigRuntimePromise:
  | Promise<typeof import("uagent/plugin-sdk/config-runtime")>
  | undefined;

async function loadSignalConfigRuntime() {
  signalConfigRuntimePromise ??= import("uagent/plugin-sdk/config-runtime");
