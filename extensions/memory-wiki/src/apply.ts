...
const GENERATED_START = "<!-- uagent:wiki:generated:start -->";
const GENERATED_END = "<!-- uagent:wiki:generated:end -->";
const HUMAN_START = "<!-- uagent:human:start -->";
const HUMAN_END = "<!-- uagent:human:end -->";
