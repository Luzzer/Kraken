...
import { buildPluginConfigSchema, z, type UAGENTPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: UAGENTPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".uagent", "wiki", "main");
}
