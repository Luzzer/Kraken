...
import { normalizeOptionalString } from "uagent/plugin-sdk/text-runtime";
import YAML from "yaml";

export const WIKI_PAGE_KINDS = ["entity", "concept", "source", "synthesis", "report"] as const;
export const WIKI_RELATED_START_MARKER = "<!-- uagent:wiki:related:start -->";
export const WIKI_RELATED_END_MARKER = "<!-- uagent:wiki:related:end -->";
