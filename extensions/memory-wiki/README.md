...
Persistent wiki compiler and Obsidian-friendly knowledge vault for **UAGENT**.
...
uagent wiki doctor
uagent wiki init
uagent wiki ingest ./notes/alpha.md
uagent wiki compile
uagent wiki lint
uagent wiki search "alpha"
uagent wiki get entity.alpha --from 1 --lines 80

uagent wiki apply synthesis "Alpha Summary" \
  --body "Short synthesis body" \
  --source-id source.alpha

uagent wiki apply metadata entity.alpha \
  --source-id source.alpha \
  --status review \
  --question "Still active?"

uagent wiki bridge import
uagent wiki unsafe-local import

uagent wiki obsidian status
uagent wiki obsidian search "alpha"
uagent wiki obsidian open syntheses/alpha-summary.md
uagent wiki obsidian command workspace:quick-switcher
uagent wiki obsidian daily
```
