...
vi.mock("uagent/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("uagent/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("uagent/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("uagent/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("uagent/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("uagent/plugin-sdk/webhook-ingress");
  return {
    ...actual,
