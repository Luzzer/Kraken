...
import {
  ...
  type UAGENTConfig,
} from "uagent/plugin-sdk/account-resolution";
import { resolveDangerousNameMatchingEnabled } from "uagent/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full UAGENT config object. */
function getChannelConfig(cfg: UAGENTConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: UAGENTConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.UAGENT_BOT_NAME ?? "UAGENT";
