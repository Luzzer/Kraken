import { DEFAULT_ACCOUNT_ID, type UAGENTConfig } from "uagent/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "uagent/plugin-sdk/webhook-ingress";
