...
import type { UAGENTPluginApi } from "../runtime-api.js";
import {
...
type BoundTaskFlow = ReturnType<
  NonNullable<UAGENTPluginApi["runtime"]>["taskFlow"]["bindSession"]
>;
...
export function createLobsterTool(api: UAGENTPluginApi, options?: LobsterToolOptions) {
