...
import { safeParseJsonWithSchema, safeParseWithSchema } from "uagent/plugin-sdk/extension-shared";
import { isSecretRef } from "uagent/plugin-sdk/secret-input";
import { z } from "zod";
...
export function listEnabledGoogleChatAccounts(cfg: UAGENTConfig): ResolvedGoogleChatAccount[] {
