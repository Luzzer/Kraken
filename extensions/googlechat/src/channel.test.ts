...
function resolveGoogleChatAccountImpl(params: { cfg: UAGENTConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: UAGENTConfig) => {
...
function createGoogleChatCfg(): UAGENTConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
