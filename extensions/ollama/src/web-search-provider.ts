...
import { resolveEnvApiKey } from "uagent/plugin-sdk/provider-auth-runtime";
import {
...
function resolveOllamaWebSearchApiKey(config?: UAGENTConfig): string | undefined {
...
function resolveOllamaWebSearchBaseUrl(config?: UAGENTConfig): string {
