...
export function resolveSearxngCategories(config?: UAGENTConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: UAGENTConfig): string | undefined {
