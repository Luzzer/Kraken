...
import { mediaKindFromMime } from "uagent/plugin-sdk/media-runtime";
import { withTempDownloadPath } from "uagent/plugin-sdk/temp-path";
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "uagent-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "uagent-feishu-resource-",
