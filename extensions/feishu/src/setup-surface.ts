...
function getScopedFeishuConfig(cfg: UAGENTConfig, accountId: string): ScopedFeishuConfig {
...
function isFeishuConfigured(cfg: UAGENTConfig, accountId?: string | null): boolean {
