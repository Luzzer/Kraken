...
import { hasConfiguredSecretInput } from "uagent/plugin-sdk/setup";
import { asRecord, hasNonEmptyString } from "./comment-shared.js";

function isFeishuDocToolEnabled(cfg: UAGENTConfig): boolean {
...
export function collectFeishuSecurityAuditFindings(params: { cfg: UAGENTConfig }) {
