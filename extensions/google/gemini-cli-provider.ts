...
import { buildOauthProviderAuthResult } from "uagent/plugin-sdk/provider-auth-result";
import { buildProviderReplayFamilyHooks } from "uagent/plugin-sdk/provider-model-shared";
import { buildProviderStreamFamilyHooks } from "uagent/plugin-sdk/provider-stream-family";
import { buildProviderToolCompatFamilyHooks } from "uagent/plugin-sdk/provider-tools";
import { fetchGeminiUsage } from "uagent/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: UAGENTPluginApi) {
