...
import { normalizeSecretInputString, type SecretInput } from "uagent/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: UAGENTConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: UAGENTConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: UAGENTConfig): string {
