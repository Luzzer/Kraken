import type { KilocodeModelCatalogEntry } from "uagent/plugin-sdk/provider-model-shared";
import type { ModelDefinitionConfig } from "uagent/plugin-sdk/provider-model-shared";
