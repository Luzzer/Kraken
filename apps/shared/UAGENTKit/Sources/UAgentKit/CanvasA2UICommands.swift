...
public enum UAGENTCanvasA2UICommand: String, Codable, Sendable {
...
public struct UAGENTCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct UAGENTCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
