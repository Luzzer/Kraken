...
public enum UAGENTTalkCommand: String, Codable, Sendable {
...
public struct UAGENTTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct UAGENTTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
