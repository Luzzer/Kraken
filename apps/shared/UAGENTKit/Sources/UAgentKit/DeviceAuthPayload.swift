...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: UAGENTProtocol.AnyCodable]?
    {
        ...
        return [
            "id": UAGENTProtocol.AnyCodable(identity.deviceId),
            "publicKey": UAGENTProtocol.AnyCodable(publicKey),
            "signature": UAGENTProtocol.AnyCodable(signature),
            "signedAt": UAGENTProtocol.AnyCodable(signedAtMs),
            "nonce": UAGENTProtocol.AnyCodable(nonce),
        ]
    }
}
