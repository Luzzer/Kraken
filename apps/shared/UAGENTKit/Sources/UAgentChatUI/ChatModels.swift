...
public typealias UAGENTPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias UAGENTPlatformImage = UIImage
#endif

public struct UAGENTChatUsageCost: Codable, Hashable, Sendable {
...
public struct UAGENTChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: UAGENTChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(UAGENTChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct UAGENTChatMessageContent: Codable, Hashable, Sendable {
...
public struct UAGENTChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [UAGENTChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: UAGENTChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [UAGENTChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: UAGENTChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(UAGENTChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([UAGENTChatMessageContent].self, forKey: .content) {
...
public struct UAGENTChatHistoryPayload: Codable, Sendable {
...
public struct UAGENTSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct UAGENTSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [UAGENTSessionPreviewItem]
}

public struct UAGENTSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [UAGENTSessionPreviewEntry]

    public init(ts: Int, previews: [UAGENTSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct UAGENTChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct UAGENTChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct UAGENTAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct UAGENTChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct UAGENTGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct UAGENTPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: UAGENTPlatformImage?
...
public struct UAGENTChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
