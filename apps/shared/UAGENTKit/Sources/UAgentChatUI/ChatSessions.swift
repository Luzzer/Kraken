...
public struct UAGENTChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct UAGENTChatSessionsDefaults: Codable, Sendable {
...
public struct UAGENTChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct UAGENTChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: UAGENTChatSessionsDefaults?
    public let sessions: [UAGENTChatSessionEntry]
    ...
    public init(
        ...
        sessions: [UAGENTChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
