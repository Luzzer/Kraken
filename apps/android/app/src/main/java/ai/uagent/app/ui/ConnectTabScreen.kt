    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text("UAGENT Android ${openClawAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("uagent qr --setup-code-only")
          CommandBlock("uagent qr --json")
          Text(
