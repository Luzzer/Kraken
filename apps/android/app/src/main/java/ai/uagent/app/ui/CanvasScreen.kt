  ...
  AndroidView(
    ...
    factory = {
      WebView(context).apply {
        ...
        if (isDebuggable) {
          Log.d("UAGENTWebView", "userAgent: ${settings.userAgentString}")
        }
        ...
        webViewClient =
          object : WebViewClient() {
            ...
            override fun onReceivedError(
              ...
              Log.e("UAGENTWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
            }
            ...
            override fun onPageFinished(view: WebView, url: String?) {
              currentPageUrlRef.set(url)
              if (isDebuggable) {
                Log.d("UAGENTWebView", "onPageFinished: $url")
              }
...
internal class CanvasA2UIActionBridge(
  ...
  companion object {
    const val interfaceName: String = "uagentCanvasA2UIAction"
  }
}
