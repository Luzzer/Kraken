...
import ai.uagent.app.gateway.GatewayClientInfo
import ai.uagent.app.gateway.GatewayConnectOptions
import ai.uagent.app.gateway.GatewayEndpoint
import ai.uagent.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "UAGENTAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "uagent-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "uagent-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
  }
