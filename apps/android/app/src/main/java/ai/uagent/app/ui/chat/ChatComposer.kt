...
import ai.uagent.app.ui.mobileAccentBorderStrong
...
import ai.uagent.app.ui.mobileSurface
import ai.uagent.app.ui.mobileText
import ai.uagent.app.ui.mobileTextSecondary
import ai.uagent.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.uagent.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.uagent.app.ui.mobileFontFamily,
