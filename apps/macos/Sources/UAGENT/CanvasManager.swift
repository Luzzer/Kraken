...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.uagent", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("UAGENT/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__uagent__/a2ui/").absoluteString + "?platform=macos"
    }
