...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .uagentSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? UAGENTPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? UAGENTPaths.stateDirURL.path
...
extension Notification.Name {
    static let uagentSelectSettingsTab = Notification.Name("uagentSelectSettingsTab")
}
