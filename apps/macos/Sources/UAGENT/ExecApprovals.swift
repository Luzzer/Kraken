...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.uagent", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        UAGENTPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        UAGENTPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
