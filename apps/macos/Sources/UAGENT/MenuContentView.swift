...
/// Menu contents for the UAGENT menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About UAGENT") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "UAGENT Not Configured"
        case .remote:
            "Remote UAGENT Active"
        case .local:
            "UAGENT Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .uagentSelectSettingsTab, object: tab)
        }
    }
