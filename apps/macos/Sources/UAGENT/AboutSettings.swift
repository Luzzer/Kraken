...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/uagent/uagent") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/uagent/uagent")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://uagent.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "UAGENTBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "UAGENTBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "UAGENTGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "UAGENTGitCommit") as? String) ??
            "unknown"
    }
