...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.uagent", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return UAGENTConfigFile.defaultWorkspaceURL() }
