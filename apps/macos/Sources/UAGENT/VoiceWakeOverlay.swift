...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.uagent", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other UAGENT windows, but below the system’s pop-up menus.
