...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = UAGENTConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = UAGENTConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: UAGENTConfigFile.loadDict(),
        ...
        UAGENTConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/uagent"
        state.remoteCliPath = ""
        return state
    }
}
