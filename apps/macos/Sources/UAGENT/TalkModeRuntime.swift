...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.uagent", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.uagent", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [UAGENTChatMessage] = messages.compactMap { item in
