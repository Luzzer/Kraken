...
enum UIStrings {
    static let welcomeTitle = "Welcome to UAGENT"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "uagent.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: UAGENTChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g uagent@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: UAGENTChatViewModel(
