...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.uagent", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".uagent/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.uagentCommand(
            subcommand: "gateway",
