...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.uagent.gateway"
    private static let nodeService = "ai.uagent.node"
    private static let talkService = "ai.uagent.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.uagent.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.uagent.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("uagent-gateway.log")
    }
