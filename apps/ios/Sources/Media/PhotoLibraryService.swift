...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: UAGENTPhotosLatestParams) async throws -> UAGENTPhotosLatestPayload {
        ...
        var results: [UAGENTPhotoPayload] = []
        ...
        return UAGENTPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> UAGENTPhotoPayload
    {
