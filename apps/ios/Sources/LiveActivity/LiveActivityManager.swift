...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.uagent.ios", category: "LiveActivity")
    private var currentActivity: Activity<UAGENTActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = UAGENTActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<UAGENTActivityAttributes>.activities
    ...
    private func updateCurrent(state: UAGENTActivityAttributes.ContentState) {
    ...
    private func connectingState() -> UAGENTActivityAttributes.ContentState {
        UAGENTActivityAttributes.ContentState(
    ...
    private func idleState() -> UAGENTActivityAttributes.ContentState {
        UAGENTActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> UAGENTActivityAttributes.ContentState {
        UAGENTActivityAttributes.ContentState(
