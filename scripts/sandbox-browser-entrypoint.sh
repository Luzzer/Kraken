...
export DISPLAY=:1
export HOME=/tmp/uagent-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${UAGENT_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${UAGENT_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${UAGENT_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${UAGENT_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${UAGENT_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${UAGENT_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${UAGENT_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${UAGENT_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${UAGENT_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${UAGENT_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${UAGENT_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
