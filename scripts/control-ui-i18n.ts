...
const ENV_PROVIDER = "UAGENT_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "UAGENT_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "UAGENT_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "UAGENT_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "UAGENT_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "UAGENT_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "UAGENT_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "UAGENT_CONTROL_UI_I18N_PROMPT_TIMEOUT";
