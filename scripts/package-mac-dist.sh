...
# Output:
# - dist/UAGENT.app
# - dist/UAGENT-<version>.zip
# - dist/UAGENT-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.uagent.mac}"
...
ZIP="$ROOT_DIR/dist/UAGENT-$VERSION.zip"
DMG="$ROOT_DIR/dist/UAGENT-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/UAGENT-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/UAGENT-$VERSION.dSYM.zip"
