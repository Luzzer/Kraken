...
export const OPTIONAL_BUNDLED_BUILD_ENV = "UAGENT_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.uagent?.install?.npmSpec === "string" &&
    packageJson.uagent.install.npmSpec.trim().length > 0
  );
}
