...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']uagent\/plugin-sdk["']/,
    hint: "Use uagent/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']uagent\/plugin-sdk\/test-utils["']/,
    hint: "Use uagent/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']uagent\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or uagent/plugin-sdk/testing for public surfaces.",
  },
  {
