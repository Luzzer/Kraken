...
show_usage() {
    cat << EOF
clawlog - UAGENT Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View UAGENT logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    UAGENT logs flow through the macOS unified log (subsystem: ai.uagent).
