...
const DEFAULT_ENTRY = "uagent.mjs";
...
function printUsage(): void {
  console.log(`UAGENT CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: uagent.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "uagent-cli-bench-"));
