...
const env = {
  ...process.env,
  UAGENT_LIVE_TEST: process.env.UAGENT_LIVE_TEST || "1",
  UAGENT_LIVE_TEST_QUIET: quietOverride ?? process.env.UAGENT_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.UAGENT_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
