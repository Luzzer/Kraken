...
const (
	envDocsPiExecutable     = "UAGENT_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "UAGENT_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "UAGENT_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "uagent", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
