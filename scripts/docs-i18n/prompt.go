...
- Keep product names in English: UAGENT, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the UAGENT Gateway, use “Gateway 网关”.
