...
- UAGENT_GATEWAY_VERSION = exact package.json version
- UAGENT_MARKETING_VERSION = short iOS/App Store version
- UAGENT_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
UAGENT_GATEWAY_VERSION = ${PACKAGE_VERSION}
UAGENT_MARKETING_VERSION = ${MARKETING_VERSION}
UAGENT_BUILD_VERSION = ${BUILD_NUMBER}
EOF
