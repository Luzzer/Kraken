...
export function connectGateway(host: GatewayHost, options?: ConnectGatewayOptions) {
  ...
  const client = new GatewayBrowserClient({
    ...
    onHello: (hello) => {
      ...
      void subscribeSessions(host as unknown as UAGENTApp);
      void loadAssistantIdentity(host as unknown as UAGENTApp);
      void loadAgents(host as unknown as UAGENTApp);
      void loadHealthState(host as unknown as UAGENTApp);
      void loadNodes(host as unknown as UAGENTApp, { quiet: true });
      void loadDevices(host as unknown as UAGENTApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as UAGENTApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as UAGENTApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as UAGENTApp, payload);
