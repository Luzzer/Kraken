...
declare global {
  interface Window {
    __UAGENT_CONTROL_UI_BASE_PATH__?: string;
  }
}
...
export class UAGENTApp extends LitElement {
...
if (!customElements.get("uagent-app")) {
  customElements.define("uagent-app", UAGENTApp);
}
